...
public class Morphology {
    ...
    public static String getWordform(String word, MorphBaseInfo morphInfo) {
        ...
        if (cla.isUndefined()) {
            MorphBaseInfo mi0 = getWordBaseInfo(word, new MorphLang(null), false, false);
            if (mi0 != null) 
                cla = mi0._getClass();
        }
    ...
    public static String convertAdverbToAdjective(String adverb, MorphBaseInfo bi) {
        ...
        MorphBaseInfo bi1 = getWordBaseInfo(var1, new MorphLang(null), false, false);
        MorphBaseInfo bi2 = getWordBaseInfo(var2, new MorphLang(null), false, false);
        String var = var1;
