...
public class FundsItemToken extends com.pullenti.ner.MetaToken {
    ...
    private static java.util.ArrayList<String> m_ActTypes = new java.util.ArrayList<>(java.util.Arrays.asList(new String[] {"ОБЫКНОВЕННЫЙ", "ПРИВИЛЕГИРОВАННЫЙ", "ГОЛОСУЮЩИЙ", "ЗВИЧАЙНИЙ", "ПРИВІЛЕЙОВАНОГО", "ГОЛОСУЄ"}));
