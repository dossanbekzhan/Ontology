...
public class MetaBusinessFact extends com.pullenti.ner.ReferentClass {
    ...
    public MetaBusinessFact() {
        super();
        com.pullenti.ner.Feature f = addFeature(com.pullenti.ner.business.BusinessFactReferent.ATTR_KIND, "Класс", 0, 1);
        kindFeature = f;
        ...
        addFeature(com.pullenti.ner.business.BusinessFactReferent.ATTR_TYPE, "Тип", 0, 1);
        addFeature(com.pullenti.ner.business.BusinessFactReferent.ATTR_WHO, "Кто", 0, 1).setShowAsParent(true);
        addFeature(com.pullenti.ner.business.BusinessFactReferent.ATTR_WHOM, "Кого\\Кому", 0, 1).setShowAsParent(true);
        addFeature(com.pullenti.ner.business.BusinessFactReferent.ATTR_WHEN, "Когда", 0, 1).setShowAsParent(true);
        addFeature(com.pullenti.ner.business.BusinessFactReferent.ATTR_WHAT, "Что", 0, 0).setShowAsParent(true);
        addFeature(com.pullenti.ner.business.BusinessFactReferent.ATTR_MISC, "Дополнительная информация", 0, 0).setShowAsParent(true);
    }
    ...
    public static MetaBusinessFact GLOBALMETA = new MetaBusinessFact();
}
