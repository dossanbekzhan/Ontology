    ...
    public static boolean canBeEqualsEx(String s1, String s2, CanBeEqualsAttrs attrs) {
        ...
        while(t1 != null || t2 != null) {
            ...
            if (!t1.chars.isLetter()) {
                ...
                else if (com.pullenti.n2j.Utils.stringsNe((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t1, com.pullenti.ner.TextToken.class))).term, (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t2, com.pullenti.ner.TextToken.class))).term)) 
                    return false;
                t1 = t1.getNext();
                t2 = t2.getNext();
                continue;
