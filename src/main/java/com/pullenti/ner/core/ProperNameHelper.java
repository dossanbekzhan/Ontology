...
public class ProperNameHelper {
    ...
    private static String getNameWithoutBrackets(com.pullenti.ner.Token begin, com.pullenti.ner.Token end, boolean normalizeFirstNounGroup, boolean normalFirstGroupSingle, boolean ignoreGeoReferent) {
        ...
        if (normalizeFirstNounGroup && !begin.getMorph()._getClass().isPreposition()) {
            ...
            if (npt != null && npt.getEndToken().endChar > end.endChar) 
                npt = null;
            if (npt != null) {
                res = npt.getNormalCaseText(new com.pullenti.morph.MorphClass(null), normalFirstGroupSingle, com.pullenti.morph.MorphGender.UNDEFINED, false);
                ...
                if (te != null && te.endChar <= end.endChar) {
                    String s = getName(te, end, com.pullenti.morph.MorphClass.UNDEFINED, com.pullenti.morph.MorphCase.UNDEFINED, com.pullenti.morph.MorphGender.UNDEFINED, true, ignoreGeoReferent);
                ...
                if (!mm.isUndefined()) {
                    ...
                    if (begin.endChar < end.endChar) 
                        res = res + " " + getName(begin.getNext(), end, com.pullenti.morph.MorphClass.UNDEFINED, com.pullenti.morph.MorphCase.UNDEFINED, com.pullenti.morph.MorphGender.UNDEFINED, true, false);
                }
            }
        }
        if (res == null) 
            res = getName(begin, end, com.pullenti.morph.MorphClass.UNDEFINED, com.pullenti.morph.MorphCase.UNDEFINED, com.pullenti.morph.MorphGender.UNDEFINED, true, ignoreGeoReferent);
        if (!com.pullenti.n2j.Utils.isNullOrEmpty(res)) {
            int k = 0;
    ...
    private static String getName(com.pullenti.ner.Token begin, com.pullenti.ner.Token end) {
        String res = getName(begin, end, com.pullenti.morph.MorphClass.UNDEFINED, com.pullenti.morph.MorphCase.UNDEFINED, com.pullenti.morph.MorphGender.UNDEFINED, false, false);
        return res;
    }

    public static String getName(com.pullenti.ner.Token begin, com.pullenti.ner.Token end, com.pullenti.morph.MorphClass cla, com.pullenti.morph.MorphCase mc, com.pullenti.morph.MorphGender gender, boolean ignoreBracketsAndHiphens, boolean ignoreGeoReferent) {
                ...
                if (BracketHelper.isBracket(t, false)) {
                    ...
                    if (t.isCharOf("(<[")) {
                        ...
                        if (br != null && br.endChar <= end.endChar) {
                            String tmp = getName(br.getBeginToken().getNext(), br.getEndToken().getPrevious(), com.pullenti.morph.MorphClass.UNDEFINED, com.pullenti.morph.MorphCase.UNDEFINED, com.pullenti.morph.MorphGender.UNDEFINED, ignoreBracketsAndHiphens, false);
                            if (tmp != null) {
            ...
            if (tt != null) {
                ...
                if (cla.value != ((short)0) || !mc.isUndefined() || gender != com.pullenti.morph.MorphGender.UNDEFINED) {
                    for(com.pullenti.morph.MorphBaseInfo wff : tt.getMorph().getItems()) {
                        ...
                        if (s == null || com.pullenti.n2j.Utils.stringsEq(wf.normalCase, tt.term)) 
                            s = wf.normalCase;
                    }
                ...
                if ((t.getMorph()._getClass().isAdjective() && nt.typ == com.pullenti.ner.NumberSpellingType.WORDS && nt.getBeginToken() == nt.getEndToken()) && (nt.getBeginToken() instanceof com.pullenti.ner.TextToken)) 
                    res.append((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(nt.getBeginToken(), com.pullenti.ner.TextToken.class))).term);
                else 
                    res.append(nt.value);
            }
            else if (t instanceof com.pullenti.ner.MetaToken) {
                if ((ignoreGeoReferent && t != begin && t.getReferent() != null) && com.pullenti.n2j.Utils.stringsEq(t.getReferent().getTypeName(), "GEO")) 
                    continue;
                String s = getName((((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.MetaToken.class))).getBeginToken(), (((com.pullenti.ner.MetaToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.MetaToken.class))).getEndToken(), cla, mc, gender, ignoreBracketsAndHiphens, ignoreGeoReferent);
                if (!com.pullenti.n2j.Utils.isNullOrEmpty(s)) {
                    if (res.length() > 0) {
                        if (!t.isWhitespaceBefore() && res.charAt(res.length() - 1) == '-') {
                        }
