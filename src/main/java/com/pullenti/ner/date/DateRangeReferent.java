...
public class DateRangeReferent extends com.pullenti.ner.Referent {
    ...
    public DateReferent getDateFrom() {
        return (DateReferent)com.pullenti.n2j.Utils.cast(getValue(ATTR_FROM), DateReferent.class);
    }
    ...
    public DateReferent setDateFrom(DateReferent value) {
        addSlot(ATTR_FROM, value, true, 0);
        return value;
    }
    ...
    public DateReferent getDateTo() {
        return (DateReferent)com.pullenti.n2j.Utils.cast(getValue(ATTR_TO), DateReferent.class);
    }
    ...
    public String toString(boolean shortVariant, com.pullenti.morph.MorphLang lang, int lev) {
        String fr = (getDateFrom() == null ? null : getDateFrom().toString(shortVariant, lang, lev, 1));
        String to = (getDateTo() == null ? null : getDateTo().toString(shortVariant, lang, lev, 2));
        if (fr != null && to != null) 
            return fr + " " + (getDateTo().getCentury() > 0 && getDateTo().getYear() == 0 ? to : to.toLowerCase());
        if (fr != null) 
            return fr.toString();
        if (to != null) 
            return to;
    ...
    public boolean canBeEquals(com.pullenti.ner.Referent obj, com.pullenti.ner.Referent.EqualType typ) {
        DateRangeReferent dr = (DateRangeReferent)com.pullenti.n2j.Utils.cast(obj, DateRangeReferent.class);
        if (dr == null) 
            return false;
        if (getDateFrom() != null) {
    ...
    public static DateRangeReferent _new691(DateReferent _arg1, DateReferent _arg2) {
        DateRangeReferent res = new DateRangeReferent();
        res.setDateFrom(_arg1);
        res.setDateTo(_arg2);
        return res;
    }
    public static DateRangeReferent _new696(DateReferent _arg1) {
        DateRangeReferent res = new DateRangeReferent();
        res.setDateTo(_arg1);
        return res;
    }
