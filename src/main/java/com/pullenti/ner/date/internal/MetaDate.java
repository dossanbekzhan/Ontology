...
public class MetaDate extends com.pullenti.ner.ReferentClass {
    ...
    public MetaDate() {
        super();
        addFeature(com.pullenti.ner.date.DateReferent.ATTR_CENTURY, "Век", 0, 1);
        addFeature(com.pullenti.ner.date.DateReferent.ATTR_YEAR, "Год", 0, 1);
        addFeature(com.pullenti.ner.date.DateReferent.ATTR_MONTH, "Месяц", 0, 1);
        addFeature(com.pullenti.ner.date.DateReferent.ATTR_DAY, "День", 0, 1);
        addFeature(com.pullenti.ner.date.DateReferent.ATTR_HOUR, "Час", 0, 1);
        addFeature(com.pullenti.ner.date.DateReferent.ATTR_MINUTE, "Минут", 0, 1);
        addFeature(com.pullenti.ner.date.DateReferent.ATTR_SECOND, "Секунд", 0, 1);
        addFeature(com.pullenti.ner.date.DateReferent.ATTR_DAYOFWEEK, "День недели", 0, 1);
        POINTER = addFeature(com.pullenti.ner.date.DateReferent.ATTR_POINTER, "Указатель", 0, 1);
        ...
        addFeature(com.pullenti.ner.date.DateReferent.ATTR_HIGHER, "Вышестоящая дата", 0, 1);
    }
    ...
    public String getImageId(com.pullenti.ner.Referent obj) {
        com.pullenti.ner.date.DateReferent dat = (com.pullenti.ner.date.DateReferent)com.pullenti.n2j.Utils.cast(obj, com.pullenti.ner.date.DateReferent.class);
    ...
    public static MetaDate GLOBALMETA = new MetaDate();
}
