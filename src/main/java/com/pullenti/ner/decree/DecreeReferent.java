...
public class DecreeReferent extends com.pullenti.ner.Referent {
    ...
    private java.util.ArrayList<Integer> _allYears() {
        ...
        for(com.pullenti.ner.Slot s : getSlots()) {
            if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), ATTR_DATE)) {
                ...
                com.pullenti.n2j.Outargwrapper<Integer> inoutarg1052 = new com.pullenti.n2j.Outargwrapper<>();
                boolean inoutres1053 = com.pullenti.n2j.Utils.parseInteger(str, inoutarg1052);
                i = (inoutarg1052.value != null ? inoutarg1052.value : 0);
                if (inoutres1053) 
                    res.add(i);
            }
        }
    ...
    public static DecreeReferent _new1045(String _arg1) {
