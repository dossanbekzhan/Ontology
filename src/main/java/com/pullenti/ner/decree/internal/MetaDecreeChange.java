...
public class MetaDecreeChange extends com.pullenti.ner.ReferentClass {
    ...
    public MetaDecreeChange() {
        super();
        addFeature(com.pullenti.ner.decree.DecreeChangeReferent.ATTR_OWNER, "Структурный элемент", 1, 0);
        com.pullenti.ner.Feature fi = addFeature(com.pullenti.ner.decree.DecreeChangeReferent.ATTR_KIND, "Тип", 1, 1);
        ...
        KINDFEATURE = fi;
        addFeature(com.pullenti.ner.decree.DecreeChangeReferent.ATTR_CHILD, "Дочернее изменение", 0, 0);
        addFeature(com.pullenti.ner.decree.DecreeChangeReferent.ATTR_VALUE, "Значение", 0, 1).setShowAsParent(true);
        addFeature(com.pullenti.ner.decree.DecreeChangeReferent.ATTR_PARAM, "Параметр", 0, 1).setShowAsParent(true);
        addFeature(com.pullenti.ner.decree.DecreeChangeReferent.ATTR_MISC, "Разное", 0, 0);
    }
    ...
    public static MetaDecreeChange GLOBALMETA = new MetaDecreeChange();
}
