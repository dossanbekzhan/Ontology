    ...
    private static void addVars(String str, java.util.ArrayList<String> vars) {
        ...
        for(int k = 0; k < 2; k++) {
            ...
            for(i = 0; i < str.length(); i++) {
                String v;
                com.pullenti.n2j.Outargwrapper<String> inoutarg1061 = new com.pullenti.n2j.Outargwrapper<>();
                Boolean inoutres1062 = com.pullenti.n2j.Utils.tryGetValue(m_VarChars, str.charAt(i), inoutarg1061);
                v = inoutarg1061.value;
                if (!inoutres1062) 
                    break;
