...
public class GeoOwnerHelper {
    ...
    public static boolean canBeHigher(com.pullenti.ner.Token rhi, com.pullenti.ner.Token rlo) {
        if (rhi == null || rlo == null) 
            return false;
        if (rhi.getMorph().getCase().isInstrumental()) 
            return false;
        com.pullenti.ner.geo.GeoReferent hi = (com.pullenti.ner.geo.GeoReferent)com.pullenti.n2j.Utils.cast(rhi.getReferent(), com.pullenti.ner.geo.GeoReferent.class);
        com.pullenti.ner.geo.GeoReferent lo = (com.pullenti.ner.geo.GeoReferent)com.pullenti.n2j.Utils.cast(rlo.getReferent(), com.pullenti.ner.geo.GeoReferent.class);
        if (hi == null || lo == null) 
            return false;
        ...
        if (hi.isRegion() && lo.isCity()) {
            if (lo.findSlot(com.pullenti.ner.geo.GeoReferent.ATTR_TYPE, "город", true) != null || lo.findSlot(com.pullenti.ner.geo.GeoReferent.ATTR_TYPE, "місто", true) != null || lo.findSlot(com.pullenti.ner.geo.GeoReferent.ATTR_TYPE, "city", true) != null) {
                ...
                if (com.pullenti.n2j.Utils.stringsEq(s, "район;")) {
    ...
    public static boolean canBeHigher(com.pullenti.ner.geo.GeoReferent hi, com.pullenti.ner.geo.GeoReferent lo) {
        ...
        if (hi.isCity()) {
            ...
            for(com.pullenti.ner.Slot s : hi.getSlots()) {
                if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), com.pullenti.ner.geo.GeoReferent.ATTR_TYPE)) {
                    if (com.pullenti.n2j.Utils.stringsNe(s.getValue().toString(), "регион") && com.pullenti.n2j.Utils.stringsNe(s.getValue().toString(), "регіон")) {
