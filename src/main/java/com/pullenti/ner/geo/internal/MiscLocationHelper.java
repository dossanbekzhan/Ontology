...
public class MiscLocationHelper {
    ...
    public static com.pullenti.ner.geo.GeoReferent getGeoReferentByName(String name) {
        ...
        com.pullenti.n2j.Outargwrapper<com.pullenti.ner.geo.GeoReferent> inoutarg1106 = new com.pullenti.n2j.Outargwrapper<>();
        Boolean inoutres1107 = com.pullenti.n2j.Utils.tryGetValue(m_GeoRefByName, name, inoutarg1106);
        res = inoutarg1106.value;
        if (inoutres1107) 
            return res;
