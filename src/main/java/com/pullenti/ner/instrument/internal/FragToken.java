...
public class FragToken extends com.pullenti.ner.MetaToken {
    ...
    private static FragToken _createDocTitle_(com.pullenti.ner.Token t0, com.pullenti.ner.instrument.InstrumentReferent doc) {
        ...
        if (t0 == null) 
            return null;
        FragToken title = _new1207(t0, t0, com.pullenti.ner.instrument.InstrumentKind.HEAD);
        ...
        if (t != null && t.isValue("ДЕЛО", "СПРАВА")) {
            ...
            if (dt != null && dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.NUMBER) {
                dt.setBeginToken(t);
                title.children.add(_new1247(t, t, com.pullenti.ner.instrument.InstrumentKind.KEYWORD, "ДЕЛО"));
        ...
        for(; t != null; t = t.getNext()) {
            ...
            if (t.isNewlineBefore() || ((t.getPrevious() != null && t.getPrevious().isTableControlChar()))) {
                ...
                if (iii != null && iii.typ == InstrToken1.Types.COMMENT) {
                    FragToken cmt = _new1207(iii.getBeginToken(), iii.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.COMMENT);
                    title.children.add(cmt);
                    t = (t1 = title.setEndToken(iii.getEndToken()));
                    continue;
                }
                if (iii != null && iii.getEndToken().isChar('?')) {
                    FragToken cmt = _new1207(iii.getBeginToken(), iii.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.NAME);
                ...
                if ((((t.isValue("ЗАЯВИТЕЛЬ", "ЗАЯВНИК") || t.isValue("ИСТЕЦ", "ПОЗИВАЧ") || t.isValue("ОТВЕТЧИК", "ВІДПОВІДАЧ")) || t.isValue("ДОЛЖНИК", "БОРЖНИК") || t.isValue("КОПИЯ", "КОПІЯ"))) && t.getNext() != null && ((t.getNext().isChar(':') || t.getNext().isTableControlChar()))) {
                    ...
                    if (ptt != null) {
                        ...
                        FragToken ft = _new1207(t, t1, com.pullenti.ner.instrument.InstrumentKind.INITIATOR);
                ...
                if (t.isValue("ЦЕНА", "ЦІНА") && t.getNext() != null && t.getNext().isValue("ИСК", "ПОЗОВ")) {
                    ...
                    if (tt != null && hasMoney) {
                        ...
                        title.children.add(_new1207(t, tt, com.pullenti.ner.instrument.InstrumentKind.CASEINFO));
                ...
                if (t.isValue("В", "У")) {
                    ...
                    if (tt != null && (tt.getReferent() instanceof com.pullenti.ner.org.OrganizationReferent)) {
                        ...
                        FragToken ooo = _new1207(t, t1, com.pullenti.ner.instrument.InstrumentKind.ORGANIZATION);
                ...
                if (t.getLengthChar() == 1 && t.chars.isLetter() && t.isWhitespaceAfter()) {
                    ...
                    for(ii = 0; ii < InstrToken.m_DirectivesNorm.size(); ii++) {
                        ...
                        if (ee != null && ee.isNewlineAfter()) {
                            FragToken ooo = _new1247(t, ee, com.pullenti.ner.instrument.InstrumentKind.KEYWORD, InstrToken.m_DirectivesNorm.get(ii));
                            title.children.add(ooo);
            ...
            if (dr0 != null) {
                if (doc.getTyp() == null || com.pullenti.n2j.Utils.stringsEq(doc.getTyp(), dr0.getTyp())) {
                    ...
                    if (li != null && li.size() > 0 && li.get(li.size() - 1).isNewlineAfter()) {
                        ...
                        if (com.pullenti.n2j.Utils.stringsEq(doc.getTyp(), "КОДЕКС")) {
                            ...
                            if (pt != null && pt.values.size() > 0) {
                                ...
                                title.children.add(_new1247(pt.getBeginToken(), pt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.DOCPART, pt.values.get(0).value));
                                t = pt.getEndToken();
                                continue;
                            }
                        }
                    ...
                    t1 = t;
                    title.children.add(_new1247(t, t, com.pullenti.ner.instrument.InstrumentKind.NAME, nam));
                    if (pt != null && pt.values.size() > 0) {
                        title.children.add(_new1247(pt.getBeginToken(), pt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.DOCPART, pt.values.get(0).value));
                        t1 = pt.getEndToken();
                    }
            ...
            if (doc.getTyp() == null) {
                ...
                if (ttt1 != null && ttt1.isNewlineAfter()) {
                    ...
                    if (doc.getTyp() == null) 
                        doc.setTyp(typ);
                    title.children.add(_new1247(t, ttt1, com.pullenti.ner.instrument.InstrumentKind.TYP, typ));
            ...
            if (dt == null) {
                ...
                if (t.isValue("ДАТА", null)) {
                    ...
                    for(com.pullenti.ner.Token tt = t.getNext(); tt != null; tt = tt.getNext()) {
                        ...
                        if (da != null) {
                            FragToken frdt = _new1207(t, tt, com.pullenti.ner.instrument.InstrumentKind.DATE);
                ...
                if (((r instanceof com.pullenti.ner.address.AddressReferent) || (r instanceof com.pullenti.ner.uri.UriReferent) || (r instanceof com.pullenti.ner.phone.PhoneReferent)) || (r instanceof com.pullenti.ner.person.PersonIdentityReferent) || (r instanceof com.pullenti.ner.bank.BankDataReferent)) {
                    FragToken cnt = _new1207(t, t, com.pullenti.ner.instrument.InstrumentKind.CONTACT);
            ...
            if (t == t0) {
                ...
                if (nam != null) {
                    ...
                    if (!com.pullenti.n2j.Utils.isNullOrEmpty(_name)) {
                        ...
                        title.children.add(_new1247(t0, t1, com.pullenti.ner.instrument.InstrumentKind.NAME, _name.trim()));
        ...
        if (endEmptyLines != null && doc.findSlot(com.pullenti.ner.instrument.InstrumentReferent.ATTR_SOURCE, null, true) == null) {
            ...
            title.children.add(0, _new1247(t0, endEmptyLines, com.pullenti.ner.instrument.InstrumentKind.ORGANIZATION, val));
        }
        ...
        if ((((_name != null || t.isNewlineBefore() || ((t.getPrevious() != null && t.getPrevious().isTableControlChar()))) || ((!t.isNewlineBefore() && title.children.size() > 0 && title.children.get(title.children.size() - 1).kind == com.pullenti.ner.instrument.InstrumentKind.TYP)))) && !isCase) {
            ...
            if (val != null) {
                ...
                title.children.add(_new1247(tt0, t1, com.pullenti.ner.instrument.InstrumentKind.NAME, val.trim()));
        ...
        for(t1 = t1.getNext(); t1 != null; t1 = t1.getNext()) {
            if (t1.isNewlineBefore() && t1.isValue("ЧАСТЬ", "ЧАСТИНА")) {
                ...
                if (pt != null && pt.isNewlineAfter()) {
                    ...
                    if (pt2 != null && (((pt2.typ == com.pullenti.ner.decree.internal.PartToken.ItemType.SECTION || pt2.typ == com.pullenti.ner.decree.internal.PartToken.ItemType.SUBSECTION || pt2.typ == com.pullenti.ner.decree.internal.PartToken.ItemType.CHAPTER) || pt2.typ == com.pullenti.ner.decree.internal.PartToken.ItemType.CLAUSE))) {
                        ...
                        doc.addSlot(com.pullenti.ner.instrument.InstrumentReferent.ATTR_PART, pt.values.get(0).value, false, 0);
                        title.children.add(_new1247(t1, pt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.DOCPART, pt.values.get(0).value));
            ...
            if ((t1.getReferent() instanceof com.pullenti.ner.decree.DecreeReferent) && (((com.pullenti.ner.decree.DecreeReferent)com.pullenti.n2j.Utils.cast(t1.getReferent(), com.pullenti.ner.decree.DecreeReferent.class))).getKind() == com.pullenti.ner.decree.DecreeKind.PUBLISHER && t1.isNewlineAfter()) {
                FragToken pub = _new1207(t1, t1, com.pullenti.ner.instrument.InstrumentKind.APPROVED);
            ...
            if (tt.isCharOf("([") && tt.isNewlineBefore()) {
                ...
                if (br != null) {
                    ...
                    title.children.add(_new1207(br.getBeginToken(), br.getEndToken(), (tt.isChar('[') ? com.pullenti.ner.instrument.InstrumentKind.NAME : com.pullenti.ner.instrument.InstrumentKind.COMMENT)));
                    continue;
                }
            }
            break;
    ...
    private static FragToken createAppendixTitle(com.pullenti.ner.Token t0, FragToken app, com.pullenti.ner.instrument.InstrumentReferent doc, boolean isApp) {
        ...
        FragToken title = _new1207(t0, t, com.pullenti.ner.instrument.InstrumentKind.HEAD);
        for(; t != null; t = t.getNext()) {
            ...
            if (t instanceof com.pullenti.ner.TextToken) 
                title.children.add(_new1225(t, t2, com.pullenti.ner.instrument.InstrumentKind.KEYWORD, true));
            ...
            if (fr.typ == InstrToken1.Types.APPENDIX && fr.numBeginToken == null) {
                ...
                if (fr1 != null && fr1.typ == InstrToken1.Types.APPROVED) {
                    t = fr1.getBeginToken();
                    title.children.add(_new1247(t, t, com.pullenti.ner.instrument.InstrumentKind.KEYWORD, t.getSourceText().toUpperCase()));
                    title.setEndToken((t = fr1.getEndToken()));
                    fr = fr1;
                }
            }
            if (fr.numBeginToken != null && fr.numEndToken != null) {
                FragToken num = _new1247(fr.numBeginToken, fr.numEndToken, com.pullenti.ner.instrument.InstrumentKind.NUMBER, com.pullenti.ner.core.MiscHelper.getTextValue(fr.numBeginToken, fr.numEndToken, com.pullenti.ner.core.GetTextAttr.KEEPREGISTER));
                ...
                if ((((com.pullenti.ner.decree.DecreeReferent)com.pullenti.n2j.Utils.cast(t.getReferent(), com.pullenti.ner.decree.DecreeReferent.class))).getKind() == com.pullenti.ner.decree.DecreeKind.PUBLISHER) {
                    FragToken ff = _new1207(t, t, com.pullenti.ner.instrument.InstrumentKind.APPROVED);
                    ...
                    FragToken appr = _new1207(kw.getBeginToken(), t, com.pullenti.ner.instrument.InstrumentKind.APPROVED);
                    title.children.remove(title.children.size() - 1);
                    appr.children.add(kw);
                    appr.children.add(_new1207(t, t, com.pullenti.ner.instrument.InstrumentKind.DOCREFERENCE));
                    title.children.add(appr);
                }
                else 
                    title.children.add(_new1207(t, t, com.pullenti.ner.instrument.InstrumentKind.DOCREFERENCE));
            }
            else if (fr.typ == InstrToken1.Types.APPROVED && fr.getLengthChar() > 15 && fr.getBeginToken() != fr.getEndToken()) 
                title.children.add(_new1207(fr.getBeginToken().getNext(), t, com.pullenti.ner.instrument.InstrumentKind.DOCREFERENCE));
            else {
                ...
                if (dts != null && dts.size() > 0 && dts.get(0).typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.TYP) {
                    FragToken dref = _new1207(dts.get(0).getBeginToken(), dts.get(0).getEndToken(), com.pullenti.ner.instrument.InstrumentKind.DOCREFERENCE);
        ...
        if (t.isValue("К", "ДО")) {
            ...
            if (maxInd >= 0) {
                ...
                te = t.getNext();
            if (te != null) {
                FragToken dr = _new1207(t, te, com.pullenti.ner.instrument.InstrumentKind.DOCREFERENCE);
        ...
        for(; t != null; t = t.getNext()) {
            ...
            if (t.isNewlineBefore()) {
                ...
                if (ltt.typ == InstrToken1.Types.APPROVED) {
                    title.children.add(_new1207(ltt.getBeginToken(), ltt.getBeginToken(), com.pullenti.ner.instrument.InstrumentKind.APPROVED));
                    if (ltt.getBeginToken() != ltt.getEndToken()) 
                        title.children.add(_new1207(ltt.getBeginToken().getNext(), ltt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.DOCREFERENCE));
                    t = ltt.getEndToken();
    ...
    private static boolean _addTitleAttr(com.pullenti.ner.instrument.InstrumentReferent doc, FragToken title, com.pullenti.ner.decree.internal.DecreeToken dt) {
        if (dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.TYP) {
            ...
            if (title != null) 
                title.children.add(_new1247(dt.getBeginToken(), dt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.TYP, (String)com.pullenti.n2j.Utils.notnull(dt.fullValue, dt.value)));
        }
            ...
            if (dt.isDelo()) {
                ...
                if (title != null) 
                    title.children.add(_new1247(dt.getBeginToken(), dt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.CASENUMBER, dt.value));
            }
            else {
                ...
                if (title != null) 
                    title.children.add(_new1247(dt.getBeginToken(), dt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.NUMBER, dt.value));
            ...
            if (title != null) 
                title.children.add(_new1247(dt.getBeginToken(), dt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.NAME, dt.value));
        }
        else if (dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.DATE) {
            if (doc == null || doc.addDate(dt)) {
                if (title != null) 
                    title.children.add(_new1247(dt.getBeginToken(), dt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.DATE, dt));
            }
        }
        else if (dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.TERR) {
            if (title != null) 
                title.children.add(_new1247(dt.getBeginToken(), dt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.PLACE, dt));
            ...
            if (title != null) 
                title.children.add(_new1247(dt.getBeginToken(), dt.getEndToken(), (dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.ORG ? com.pullenti.ner.instrument.InstrumentKind.ORGANIZATION : com.pullenti.ner.instrument.InstrumentKind.INITIATOR), dt));
            if (doc != null) {
                if (dt.ref != null) {
    ...
    public boolean _analizeTables() {
        ...
        for(com.pullenti.ner.Token tt = getBeginToken(); tt != null && tt.endChar <= _endChar; tt = tt.getNext()) {
            ...
            if (t0.endChar < rows.get(0).beginChar) 
                children.add(_new1207(t0, rows.get(0).getBeginToken().getPrevious(), com.pullenti.ner.instrument.InstrumentKind.CONTENT));
            FragToken tab = _new1207(rows.get(0).getBeginToken(), rows.get(rows.size() - 1).getEndToken(), com.pullenti.ner.instrument.InstrumentKind.TABLE);
            children.add(tab);
            for(int i = 0; i < rows.size(); i++) {
                FragToken rr = _new1223(rows.get(i).getBeginToken(), rows.get(i).getEndToken(), com.pullenti.ner.instrument.InstrumentKind.TABLEROW, i + 1);
                tab.children.add(rr);
                tabs = true;
                int no = 0;
                int cols = 0;
                for(com.pullenti.ner.core.internal.TableCellToken ce : rows.get(i).cells) {
                    FragToken cell = _new1223(ce.getBeginToken(), ce.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.TABLECELL, ++no);
                    if (ce.colSpan > 1) 
        ...
        if ((t0 != null && (t0.endChar < endChar) && tabs) && t0 != getEndToken()) 
            children.add(_new1207(t0, getEndToken(), com.pullenti.ner.instrument.InstrumentKind.CONTENT));
        return tabs;
    }
    ...
    public void fillByContentChildren() {
        sortChildren();
        if (children.size() == 0) {
            children.add(_new1207(getBeginToken(), getEndToken(), com.pullenti.ner.instrument.InstrumentKind.CONTENT));
            return;
        }
        if (beginChar < children.get(0).beginChar) 
            children.add(0, _new1207(getBeginToken(), children.get(0).getBeginToken().getPrevious(), com.pullenti.ner.instrument.InstrumentKind.CONTENT));
        for(int i = 0; i < (children.size() - 1); i++) {
            if (children.get(i).getEndToken().getNext() != children.get(i + 1).getBeginToken() && (children.get(i).getEndToken().getNext().endChar < children.get(i + 1).beginChar)) 
                children.add(i + 1, _new1207(children.get(i).getEndToken().getNext(), children.get(i + 1).getBeginToken().getPrevious(), com.pullenti.ner.instrument.InstrumentKind.CONTENT));
        }
        if (children.get(children.size() - 1).endChar < endChar) 
            children.add(_new1207(children.get(children.size() - 1).getEndToken().getNext(), getEndToken(), com.pullenti.ner.instrument.InstrumentKind.CONTENT));
    }
    ...
    public static FragToken createDocument(com.pullenti.ner.Token t, int maxChar, com.pullenti.ner.instrument.InstrumentKind rootKind) {
        ...
        if (res != null) 
            return res;
        res = _new1207(t, t, com.pullenti.ner.instrument.InstrumentKind.DOCUMENT);
        ...
        for(i = i1 - 1; i > 0; i--) {
            ...
            if ((lii.typ == ILTypes.PERSON || lii.typ == ILTypes.REGNUMBER || lii.typ == ILTypes.DATE) || lii.typ == ILTypes.GEO) {
                ...
                if (tail == null) {
                    tail = _new1207(li.get(i).getBeginToken(), li.get(i1 - 1).getEndToken(), com.pullenti.ner.instrument.InstrumentKind.TAIL);
                    if ((i1 - 1) > i) {
                    }
                }
                ...
                if (li.get(i).isPodpisStoron() && tail != null) {
                    ...
                    tail.children.add(0, _new1247(li.get(i).getBeginToken(), li.get(i).getEndToken(), com.pullenti.ner.instrument.InstrumentKind.NAME, ss));
                    cMax = i - 1;
                    break;
                }
                int jj;
        ...
        if (cMax < 0) {
            ...
            FragToken content = _new1207(li.get(0).getBeginToken(), li.get(cMax).getEndToken(), com.pullenti.ner.instrument.InstrumentKind.CONTENT);
        ...
        if (tail != null) {
            ...
            for(; i1 < li.size(); i1++) {
                if (li.get(i1).getBeginToken() == li.get(i1).getEndToken() && (li.get(i1).getBeginToken().getReferent() instanceof com.pullenti.ner.decree.DecreeReferent) && (((com.pullenti.ner.decree.DecreeReferent)com.pullenti.n2j.Utils.cast(li.get(i1).getBeginToken().getReferent(), com.pullenti.ner.decree.DecreeReferent.class))).getKind() == com.pullenti.ner.decree.DecreeKind.PUBLISHER) {
                    FragToken ap = _new1207(li.get(i1).getBeginToken(), li.get(i1).getEndToken(), com.pullenti.ner.instrument.InstrumentKind.APPROVED);
            ...
            if (tail.children.size() > 0 && (tail.children.get(tail.children.size() - 1).endChar < tail.endChar)) {
                FragToken unkw = _new1207(tail.children.get(tail.children.size() - 1).getEndToken().getNext(), tail.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.UNDEFINED);
        ...
        for(i = i1; i < li.size(); i++) {
            ...
            if (li.get(j - 1).typ == ILTypes.PERSON && li.get(j - 1).isNewlineBefore() && li.get(j - 1).isNewlineAfter()) {
                tail = _new1207(li.get(j - 1).getBeginToken(), li.get(j - 1).getEndToken(), com.pullenti.ner.instrument.InstrumentKind.TAIL);
                for(int jj = j - 1; jj > i; jj--) {
                    if (li.get(jj).typ != ILTypes.PERSON || !li.get(jj).isNewlineBefore() || !li.get(jj).isNewlineAfter()) 
                        break;
                    else {
                        FragToken fr = _new1207(li.get(jj).getBeginToken(), li.get(jj).getEndToken(), com.pullenti.ner.instrument.InstrumentKind.SIGNER);
            ...
            if (title == null) {
                ...
                if (isApp && app.kind == com.pullenti.ner.instrument.InstrumentKind.APPENDIX) {
                    ...
                    FragToken res0 = _new1309(res.getBeginToken(), res.getEndToken(), res.m_Doc, com.pullenti.ner.instrument.InstrumentKind.DOCUMENT);
                    res.m_Doc = null;
                ...
                if (title.getEndToken().getNext() != null) {
                    if (title.getEndToken().endChar < app.getEndToken().beginChar) {
                        FragToken acontent = _new1207(title.getEndToken().getNext(), app.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.CONTENT);
    ...
    private static FragToken _createCaseInfo(com.pullenti.ner.Token t) {
        ...
        if ((!hasDate && t1.getNext() != null && (t1.getNext().getReferent() instanceof com.pullenti.ner.date.DateReferent)) && t1.getNext().isNewlineAfter()) 
            t1 = t1.getNext();
        return _new1207(t, t1, com.pullenti.ner.instrument.InstrumentKind.CASEINFO);
    }
    ...
    private static FragToken _createApproved(com.pullenti.ner.Token t) {
        ...
        if (tt != null) 
            res = _new1207(t, tt, com.pullenti.ner.instrument.InstrumentKind.APPROVED);
            ...
            if (t.getMorph().containsAttr("инф.", new com.pullenti.morph.MorphClass(null)) && t.getMorph().containsAttr("сов.в.", new com.pullenti.morph.MorphClass(null))) {
                ...
                res = _new1207(t, t, com.pullenti.ner.instrument.InstrumentKind.APPROVED);
        }
        ...
        if (dts != null && dts.size() > 0) {
            for(int i = 0; i < dts.size(); i++) {
                ...
                if (dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.ORG) 
                    res.children.add(_new1247(dt.getBeginToken(), dt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.ORGANIZATION, dt));
                else if (dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.OWNER) 
                    res.children.add(_new1247(dt.getBeginToken(), dt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.INITIATOR, dt));
                else if (dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.DATE) 
                    res.children.add(_new1247(dt.getBeginToken(), dt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.DATE, dt));
                    ...
                    res.children.add(_new1247(dt.getBeginToken(), dt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.NUMBER, dt));
                    ...
                    res.children.add(_new1247(dt.getBeginToken(), dt.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.PLACE, dt));
                else 
                    break;
    ...
    public static FragToken _createMisc(com.pullenti.ner.Token t) {
        ...
        if (t.isValue("ФОРМА", null) && t.getNext().isValue("ДОКУМЕНТА", null)) {
            ...
            if (num != null && num.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.NUMBER) 
                return _new1207(t, num.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.UNDEFINED);
            if ((t.getNext().getNext() instanceof com.pullenti.ner.NumberToken) && t.getNext().getNext().isNewlineAfter()) 
                return _new1207(t, t.getNext().getNext(), com.pullenti.ner.instrument.InstrumentKind.UNDEFINED);
        }
        if (t.isValue("С", null) && t.getNext().isValue("ИЗМЕНЕНИЕ", null) && t.getNext().getNext() != null) {
            ...
            if (tt.getReferent() instanceof com.pullenti.ner.date.DateReferent) {
                if (tt.getNext() != null && tt.getNext().isChar('.')) 
                    tt = tt.getNext();
                return _new1207(t, tt, com.pullenti.ner.instrument.InstrumentKind.UNDEFINED);
            }
        }
        return null;
    }
    ...
    public static FragToken _createEditions(com.pullenti.ner.Token t) {
        ...
        if (decrs.size() > 0) 
            isDoubt = false;
        if (ok && !isDoubt) {
            FragToken eds = _new1207(t0, t, com.pullenti.ner.instrument.InstrumentKind.EDITIONS);
    ...
    private static FragToken _createOwner(com.pullenti.ner.Token t) {
        ...
        if (t1 == null) 
            return null;
        FragToken fr = _new1225(t, t1, com.pullenti.ner.instrument.InstrumentKind.ORGANIZATION, true);
        return fr;
    }
    ...
    private static FragToken createZapiskaTitle(com.pullenti.ner.Token t0, com.pullenti.ner.instrument.InstrumentReferent doc) {
        ...
        for(com.pullenti.ner.Token t = t0; t != null && (cou < 30); t = t.getNext(),cou++) {
            ...
            if (ok) {
                FragToken res = _new1207(t0, li.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.HEAD);
                if (li.getBeginToken() != t0) {
                    FragToken hh = _new1207(t0, li.getBeginToken().getPrevious(), com.pullenti.ner.instrument.InstrumentKind.APPROVED);
                    res.children.add(hh);
                }
                res.children.add(_new1231(li.getBeginToken(), li.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.KEYWORD, true));
                return res;
            }
            t = li.getEndToken();
        }
    ...
    private static FragToken createContractTitle(com.pullenti.ner.Token t0, com.pullenti.ner.instrument.InstrumentReferent doc) {
        ...
        if (t1 == null) 
            return null;
        com.pullenti.ner.instrument.InstrumentParticipant p1 = com.pullenti.ner.instrument.InstrumentParticipant._new1331(par1.typ);
        if (par1.parts != null) {
        ...
        if (par1.kind == ParticipantToken.Kinds.NAMEDASPARTS) {
            ...
            for(int ii = 1; ii < par1.parts.size(); ii++) {
                com.pullenti.ner.instrument.InstrumentParticipant pp = com.pullenti.ner.instrument.InstrumentParticipant._new1331("СТОРОНА " + (ii + 1));
            ...
            if ((dttyp != null && namBeg == null && t.chars.isCyrillicLetter()) && (t instanceof com.pullenti.ner.TextToken)) {
                if (t.isValue("МЕЖДУ", "МІЖ")) {
                    ...
                    if (pp != null && pp.getEndToken().getNext() != null && pp.getEndToken().getNext().isAnd()) {
                        ...
                        if (pp2 != null) {
                            FragToken fr = _new1207(t, pp2.getEndToken(), com.pullenti.ner.instrument.InstrumentKind.PLACE);
        ...
        if (namEnd != null && namBeg != null) {
            ...
            if (val != null && val.length() > 3) {
                FragToken nam = _new1247(namBeg, namEnd, com.pullenti.ner.instrument.InstrumentKind.NAME, val);
        ...
        if (title.children.size() > 0 && title.children.get(0).beginChar > title.beginChar) 
            title.children.add(0, _new1207(title.getBeginToken(), title.children.get(0).getBeginToken().getPrevious(), com.pullenti.ner.instrument.InstrumentKind.UNDEFINED));
        ...
        if (par2 == null) {
            ...
            if (tt2 != null && par1 != null) {
                ...
                if (typ2 != null) 
                    par2 = ParticipantToken._new1337(tt2, tt2, typ2);
            }
        }
        ...
        if (par2 != null) {
            p2 = com.pullenti.ner.instrument.InstrumentParticipant._new1331(par2.typ);
            if (par2.parts != null) {
    ...
    private static FragToken createProjectTitle(com.pullenti.ner.Token t0, com.pullenti.ner.instrument.InstrumentReferent doc) {
        ...
        for(t = t0; t != null; t = t.getNext()) {
            ...
            if ((t instanceof com.pullenti.ner.TextToken) && ((com.pullenti.n2j.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, "ПРОЕКТ") || com.pullenti.n2j.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, "ЗАКОНОПРОЕКТ")))) {
                if ((t.isValue("ПРОЕКТ", null) && t == t0 && (t.getNext() instanceof com.pullenti.ner.ReferentToken)) && (t.getNext().getReferent() instanceof com.pullenti.ner.org.OrganizationReferent)) 
                    return null;
                isProject = true;
                title.children.add(_new1225(t, t, com.pullenti.ner.instrument.InstrumentKind.KEYWORD, true));
            ...
            if (tt != null) {
                isEntered = true;
                title.children.add(_new1207(t, tt, com.pullenti.ner.instrument.InstrumentKind.APPROVED));
                t = tt;
                continue;
            }
            tt = _attachProjectMisc(t);
            if (tt != null) {
                title.children.add(_new1207(t, tt, (tt.isValue("ЧТЕНИЕ", "ЧИТАННЯ") ? com.pullenti.ner.instrument.InstrumentKind.EDITIONS : com.pullenti.ner.instrument.InstrumentKind.UNDEFINED)));
                t = tt;
                continue;
            }
        ...
        if (t11 == null) 
            return null;
        FragToken nam = _new1225(t00, t11, com.pullenti.ner.instrument.InstrumentKind.NAME, true);
    ...
    private static void _createJusticeParticipants(FragToken title, com.pullenti.ner.instrument.InstrumentReferent doc) {
        ...
        while(t != null) {
            ...
            if (tmp.length() > 10 && t1 != null) {
                com.pullenti.ner.instrument.InstrumentArtefact art = com.pullenti.ner.instrument.InstrumentArtefact._new1344("предмет");
    ...
    private static com.pullenti.ner.ReferentToken _createJustParticipant(com.pullenti.ner.Token t, String typ) {
        ...
        if (!ok) 
            return null;
        com.pullenti.ner.instrument.InstrumentParticipant pat = com.pullenti.ner.instrument.InstrumentParticipant._new1331(typ);
    ...
    private void _createJusticeResolution() {
        ...
        for(com.pullenti.ner.Token t = res.getBeginToken(); t != null && t.endChar <= res.endChar; t = t.getNext()) {
            ...
            if (t.isValue("ВЗЫСКАТЬ", "СТЯГНУТИ")) {
                ...
                if (sum != null) {
                    com.pullenti.ner.instrument.InstrumentArtefact art = com.pullenti.ner.instrument.InstrumentArtefact._new1344("РЕЗОЛЮЦИЯ");
                    if (gosposh) 
            ...
            if (children.get(i).kind == com.pullenti.ner.instrument.InstrumentKind.DIRECTIVE && ((i + 1) < children.size())) {
                ...
                if ((((com.pullenti.n2j.Utils.stringsEq(s, "РЕШЕНИЕ") || com.pullenti.n2j.Utils.stringsEq(s, "ОПРЕДЕЛЕНИЕ") || com.pullenti.n2j.Utils.stringsEq(s, "ПОСТАНОВЛЕНИЕ")) || com.pullenti.n2j.Utils.stringsEq(s, "ПРИГОВОР") || com.pullenti.n2j.Utils.stringsEq(s, "РІШЕННЯ")) || com.pullenti.n2j.Utils.stringsEq(s, "ВИЗНАЧЕННЯ") || com.pullenti.n2j.Utils.stringsEq(s, "ПОСТАНОВА")) || com.pullenti.n2j.Utils.stringsEq(s, "ВИРОК")) {
                    ...
                    if (ii == (i + 1)) 
                        ...
                        return _new1207(children.get(i + 1).getBeginToken(), children.get(ii).getEndToken(), com.pullenti.ner.instrument.InstrumentKind.CONTENT);
                }
                dir = true;
            }
        }
    ...
    private static FragToken __createActionQuestion(com.pullenti.ner.Token t, int maxChar) {
        ...
        if (res == null) 
            return null;
        FragToken ques = _new1207(t, t2.getPrevious(), com.pullenti.ner.instrument.InstrumentKind.QUESTION);
        res.children.add(0, ques);
        ques.children.add(_new1207(li.get(li.size() - 1).getBeginToken(), li.get(li.size() - 1).getEndToken(), com.pullenti.ner.instrument.InstrumentKind.KEYWORD));
        FragToken content = _new1207(li.get(li.size() - 1).getEndToken().getNext(), t2.getPrevious(), com.pullenti.ner.instrument.InstrumentKind.CONTENT);
        ques.children.add(content);
        content._analizeContent(res, maxChar > 0, com.pullenti.ner.instrument.InstrumentKind.UNDEFINED);
        if (li.size() > 1) {
            FragToken fr = _new1231(t, li.get(li.size() - 2).getEndToken(), com.pullenti.ner.instrument.InstrumentKind.NAME, true);
    ...
    public static FragToken _new1207(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.instrument.InstrumentKind _arg3) {
        FragToken res = new FragToken(_arg1, _arg2);
        res.kind = _arg3;
        return res;
    }
    public static FragToken _new1208(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, InstrToken1 _arg3, boolean _arg4) {
        FragToken res = new FragToken(_arg1, _arg2);
        res.itok = _arg3;
        res.isExpired = _arg4;
        return res;
    }
    public static FragToken _new1209(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.instrument.InstrumentKind _arg3, boolean _arg4, InstrToken1 _arg5) {
        FragToken res = new FragToken(_arg1, _arg2);
        res.kind = _arg3;
    ...
    public static FragToken _new1215(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, InstrToken1 _arg3) {
        FragToken res = new FragToken(_arg1, _arg2);
        res.itok = _arg3;
        return res;
    }
    public static FragToken _new1216(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.instrument.InstrumentKind _arg3, InstrToken1 _arg4) {
        FragToken res = new FragToken(_arg1, _arg2);
        res.kind = _arg3;
        res.itok = _arg4;
        return res;
    }
    public static FragToken _new1223(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.instrument.InstrumentKind _arg3, int _arg4) {
        FragToken res = new FragToken(_arg1, _arg2);
        res.kind = _arg3;
        res.number = _arg4;
        return res;
    }
    public static FragToken _new1225(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.instrument.InstrumentKind _arg3, boolean _arg4) {
        FragToken res = new FragToken(_arg1, _arg2);
        res.kind = _arg3;
        res.setDefVal2(_arg4);
        return res;
    }
    public static FragToken _new1231(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.instrument.InstrumentKind _arg3, boolean _arg4) {
        FragToken res = new FragToken(_arg1, _arg2);
        res.kind = _arg3;
        res.setDefVal(_arg4);
        return res;
    }
    public static FragToken _new1235(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.instrument.InstrumentKind _arg3, Object _arg4, InstrToken1 _arg5) {
        FragToken res = new FragToken(_arg1, _arg2);
        res.kind = _arg3;
        res.value = _arg4;
        res.itok = _arg5;
    ...
    public static FragToken _new1240(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.instrument.InstrumentKind _arg3, int _arg4, boolean _arg5, java.util.ArrayList<com.pullenti.ner.Referent> _arg6) {
        FragToken res = new FragToken(_arg1, _arg2);
        res.kind = _arg3;
        res.number = _arg4;
        res.isExpired = _arg5;
    ...
    public static FragToken _new1247(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.instrument.InstrumentKind _arg3, Object _arg4) {
        FragToken res = new FragToken(_arg1, _arg2);
        res.kind = _arg3;
        res.value = _arg4;
        return res;
    }
    public static FragToken _new1309(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.instrument.InstrumentReferent _arg3, com.pullenti.ner.instrument.InstrumentKind _arg4) {
        FragToken res = new FragToken(_arg1, _arg2);
        res.m_Doc = _arg3;
        res.kind = _arg4;
        return res;
    }
    public static FragToken _new1407(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.instrument.InstrumentKind _arg3, boolean _arg4, InstrToken1 _arg5) {
        FragToken res = new FragToken(_arg1, _arg2);
        res.kind = _arg3;
        res.setDefVal(_arg4);
        res.itok = _arg5;
