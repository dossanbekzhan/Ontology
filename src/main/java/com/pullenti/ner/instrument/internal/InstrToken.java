...
public class InstrToken extends com.pullenti.ner.MetaToken {
    ...
    public static void initialize() {
        ...
        t.addAbridge("Ф.И.О.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new1357("ПРІЗВИЩЕ ІМЯ ПО БАТЬКОВІ", com.pullenti.morph.MorphLang.UA, "ФИО");
        m_Ontology.add(t);
    ...
    public static InstrToken parse(com.pullenti.ner.Token t, int maxChar, InstrToken prev) {
        ...
        for(; t != null; t = t.getNext()) {
            ...
            if (isStartOfLine && t == t0) {
                ...
                if ((t.getReferent() instanceof com.pullenti.ner.person.PersonReferent) || (t.getReferent() instanceof com.pullenti.ner.person.PersonPropertyReferent) || (t.getReferent() instanceof com.pullenti.ner.instrument.InstrumentParticipant)) 
                    return _correctPerson(_new1358(t00, t, ILTypes.PERSON, t));
                boolean isRef = false;
                if (t.getReferent() instanceof com.pullenti.ner.person.PersonPropertyReferent) {
                    ...
                    if (rt != null) {
                        if (rt.referent instanceof com.pullenti.ner.person.PersonReferent) 
                            return _new1359(t00, rt.getEndToken(), ILTypes.PERSON);
                ...
                for(; tt != null; tt = tt.getNext()) {
                    ...
                    if (re instanceof com.pullenti.ner.person.PersonReferent) 
                        return _new1358(t00, tt, ILTypes.PERSON, tt);
                ...
                if (tt == null && isRef) 
                    return _new1358(t00, (com.pullenti.ner.Token)com.pullenti.n2j.Utils.notnull(t11, t), ILTypes.PERSON, t);
            }
            ...
            if (dt != null) {
                if (dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.TYP && !t.chars.isAllLower()) {
                    ...
                    if (!_hasVerb) {
                        InstrToken res2 = _new1362(t0, dt.getEndToken(), ILTypes.TYP, (String)com.pullenti.n2j.Utils.notnull(dt.fullValue, dt.value));
                ...
                if (dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.NUMBER) {
                    if (t != t0) 
                        break;
                    return _new1362(t0, dt.getEndToken(), ILTypes.REGNUMBER, dt.value);
                }
                if (dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.ORG) {
                    if (t != t0) 
                        break;
                    return _new1364(t0, dt.getEndToken(), ILTypes.ORGANIZATION, dt.ref, dt.value);
                }
                if (dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.TERR) {
                    if (t != t0) 
                        break;
                    InstrToken re = _new1364(t0, dt.getEndToken(), ILTypes.GEO, dt.ref, dt.value);
                ...
                if (dt.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.OWNER) {
                    ...
                    if (dt.ref != null && dt.ref.referent.toString().startsWith("агент")) 
                        dt = null;
                    if (dt != null) {
                        InstrToken res1 = _new1364(t0, dt.getEndToken(), ILTypes.PERSON, dt.ref, dt.value);
            ...
            if (r instanceof com.pullenti.ner.date.DateReferent) {
                ...
                if (t != t0) 
                    break;
                return _new1358(t, t, ILTypes.DATE, t);
            }
            ...
            if ((r instanceof com.pullenti.ner.person.PersonReferent) || (r instanceof com.pullenti.ner.person.PersonPropertyReferent) || (r instanceof com.pullenti.ner.instrument.InstrumentParticipant)) {
                ...
                InstrToken res1 = _new1358(t, t, ILTypes.PERSON, t);
                return _correctPerson(res1);
            }
            if (r instanceof com.pullenti.ner.org.OrganizationReferent) {
                if (t != t0) 
                    break;
                return _new1358(t, t, ILTypes.ORGANIZATION, t);
            }
                ...
                if (dpr.getAppendix() != null) {
                    if (t.isNewlineBefore() || isStartOfLine) {
                        if (t.isNewlineAfter() || t.getWhitespacesBeforeCount() > 30) 
                            return _new1362(t, t, ILTypes.APPENDIX, "ПРИЛОЖЕНИЕ");
                        boolean ok = true;
            ...
            if ((r instanceof com.pullenti.ner.decree.DecreeReferent) && (((com.pullenti.ner.decree.DecreeReferent)com.pullenti.n2j.Utils.cast(r, com.pullenti.ner.decree.DecreeReferent.class))).getKind() == com.pullenti.ner.decree.DecreeKind.PUBLISHER && t == t0) {
                InstrToken res1 = _new1359(t, t, ILTypes.APPROVED);
                for(com.pullenti.ner.Token tt = t.getNext(); tt != null; tt = tt.getNext()) {
                    if (tt.isCharOf(",;")) 
                        continue;
            ...
            if (t.isValue("ЗА", null) && t.getNext() != null && t.isNewlineBefore()) {
                ...
                if ((rr instanceof com.pullenti.ner.person.PersonReferent) || (rr instanceof com.pullenti.ner.person.PersonPropertyReferent) || (rr instanceof com.pullenti.ner.instrument.InstrumentParticipant)) {
                    if (t != t0) 
                        break;
                    InstrToken res1 = _new1358(t, t.getNext(), ILTypes.PERSON, t.getNext());
                    t = t.getNext().getNext();
            ...
            for(int ii = 0; ii < m_Directives.size(); ii++) {
                if (t.isValue(m_Directives.get(ii), null)) {
                    if (t.getNext() != null && t.getNext().isValue("СЛЕДУЮЩЕЕ", "НАСТУПНЕ")) {
                        ...
                        if (ok) 
                            return _new1362(t, t11, ILTypes.DIRECTIVE, m_DirectivesNorm.get(ii));
                    }
                    if (t.isNewlineAfter() || ((t.getNext() != null && t.getNext().isChar(':') && t.getNext().isNewlineAfter()))) {
                        ...
                        return _new1362(t, (t.isNewlineAfter() ? t : t.getNext()), ILTypes.DIRECTIVE, m_DirectivesNorm.get(ii));
                    }
                    break;
                }
            }
                ...
                for(String d : m_Directives) {
                    ...
                    if (t11 != null) {
                        if (t11.getNext() != null && t11.getNext().isChar(':')) 
                            t11 = t11.getNext();
                        return _new1359(t, t11, ILTypes.DIRECTIVE);
                    }
                }
            }
            ...
            if (isStartOfLine && !tte.chars.isAllLower() && t == t0) {
                ...
                if (npt != null && npt.getMorph().getCase().isNominative() && (npt.getEndToken() instanceof com.pullenti.ner.TextToken)) {
                    ...
                    if (((com.pullenti.n2j.Utils.stringsEq(term1, "ПРИЛОЖЕНИЕ") || com.pullenti.n2j.Utils.stringsEq(term1, "ДОДАТОК") || com.pullenti.n2j.Utils.stringsEq(term1, "МНЕНИЕ")) || com.pullenti.n2j.Utils.stringsEq(term1, "ДУМКА") || com.pullenti.n2j.Utils.stringsEq(term1, "АКТ")) || com.pullenti.n2j.Utils.stringsEq(term1, "ФОРМА") || com.pullenti.n2j.Utils.stringsEq(term, "ЗАЯВКА")) {
                        ...
                        if (ok) 
                            return _new1362(t, t, ILTypes.APPENDIX, term1);
                    }
                }
            }
            boolean app = false;
            ...
            if (app) {
                ...
                if (app) 
                    return _new1359(t, t.getNext(), ILTypes.APPENDIX);
            }
            if (!t.chars.isAllLower() && t == t0) {
                ...
                if (tt != null) {
                    if (tt.getNext() != null && (tt.getNext().getReferent() instanceof com.pullenti.ner.decree.DecreeReferent)) 
                        return _new1358(t, tt, ILTypes.APPROVED, tt.getNext().getReferent());
                    ...
                    if (dt1 != null && dt1.typ == com.pullenti.ner.decree.internal.DecreeToken.ItemType.TYP) 
                        return _new1359(t, tt, ILTypes.APPROVED);
                }
            }
            t1 = t;
        }
        if (t1 == null) 
            return null;
        InstrToken res = _new1359(t00, t1, ILTypes.UNDEFINED);
        res.noWords = true;
    ...
    public static java.util.ArrayList<String> m_Directives = new java.util.ArrayList<>(java.util.Arrays.asList(new String[] {"ПРИКАЗЫВАТЬ", "ОПРЕДЕЛЯТЬ", "ОПРЕДЕЛИТЬ", "ПОСТАНОВЛЯТЬ", "ПОСТАНОВИТЬ", "УСТАНОВИТЬ", "РЕШИЛ", "РЕШИТЬ", "ПРОСИТЬ", "ПРИГОВАРИВАТЬ", "ПРИГОВОРИТЬ", "НАКАЗУВАТИ", "ВИЗНАЧАТИ", "ВИЗНАЧИТИ", "УХВАЛЮВАТИ", "ПОСТАНОВЛЯТИ", "ПОСТАНОВИТИ", "ВСТАНОВИТИ", "ВИРІШИВ", "ВИРІШИТИ", "ПРОСИТИ", "ПРИМОВЛЯТИ", "ЗАСУДИТИ"}));

    public static java.util.ArrayList<String> m_DirectivesNorm = new java.util.ArrayList<>(java.util.Arrays.asList(new String[] {"ПРИКАЗ", "ОПРЕДЕЛЕНИЕ", "ОПРЕДЕЛЕНИЕ", "ПОСТАНОВЛЕНИЕ", "ПОСТАНОВЛЕНИЕ", "УСТАНОВЛЕНИЕ", "РЕШЕНИЕ", "РЕШЕНИЕ", "ЗАЯВЛЕНИЕ", "ПРИГОВОР", "ПРИГОВОР", "НАКАЗ", "УХВАЛА", "УХВАЛА", "ПОСТАНОВА", "ПОСТАНОВА", "ПОСТАНОВА", "ВСТАНОВЛЕННЯ", "РІШЕННЯ", "РІШЕННЯ", "ЗАЯВА", "ВИРОК", "ВИРОК"}));

    public static InstrToken _new1358(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ILTypes _arg3, Object _arg4) {
        InstrToken res = new InstrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.ref = _arg4;
        return res;
    }
    public static InstrToken _new1359(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ILTypes _arg3) {
        InstrToken res = new InstrToken(_arg1, _arg2);
        res.typ = _arg3;
        return res;
    }
    public static InstrToken _new1362(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ILTypes _arg3, String _arg4) {
        InstrToken res = new InstrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        return res;
    }
    public static InstrToken _new1364(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ILTypes _arg3, Object _arg4, String _arg5) {
        InstrToken res = new InstrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.ref = _arg4;
        res.value = _arg5;
