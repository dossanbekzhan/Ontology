...
public class GeneralRelationHelper {
    ...
    public static void refreshGenerals(com.pullenti.ner.Processor proc, com.pullenti.ner.core.AnalysisKit kit) {
        ...
        for(com.pullenti.ner.Analyzer a : proc.getAnalyzers()) {
            ...
            for(com.pullenti.ner.Referent r : ad.getReferents()) {
                Node nod = Node._new1439(r, ad);
                allRefs.add(nod);
                r.setTag(nod);
                java.util.HashMap<String, java.util.ArrayList<com.pullenti.ner.Referent>> si;
                com.pullenti.n2j.Outargwrapper<java.util.HashMap<String, java.util.ArrayList<com.pullenti.ner.Referent>>> inoutarg1442 = new com.pullenti.n2j.Outargwrapper<>();
                Boolean inoutres1443 = com.pullenti.n2j.Utils.tryGetValue(all, a.getName(), inoutarg1442);
                si = inoutarg1442.value;
                if (!inoutres1443) 
                ...
                for(String s : strs) {
                    ...
                    com.pullenti.n2j.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>> inoutarg1440 = new com.pullenti.n2j.Outargwrapper<>();
                    Boolean inoutres1441 = com.pullenti.n2j.Utils.tryGetValue(si, s, inoutarg1440);
                    li = inoutarg1440.value;
                    if (!inoutres1441) 
    ...
    public static class Node {
        ...
        public static Node _new1439(com.pullenti.ner.Referent _arg1, com.pullenti.ner.core.AnalyzerData _arg2) {
            Node res = new Node();
            res.ref = _arg1;
            res.ad = _arg2;
            return res;
