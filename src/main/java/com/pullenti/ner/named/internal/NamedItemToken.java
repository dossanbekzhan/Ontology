...
public class NamedItemToken extends com.pullenti.ner.MetaToken {
    ...
    public static NamedItemToken tryParse(com.pullenti.ner.Token t, com.pullenti.ner.core.IntOntologyCollection locOnto) {
        ...
        if (t instanceof com.pullenti.ner.ReferentToken) {
            ...
            if ((com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "PERSON") || com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "PERSONPROPERTY") || (r instanceof com.pullenti.ner.geo.GeoReferent)) || com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "ORGANIZATION")) 
                return _new1583(t, t, r, t.getMorph());
            return null;
        }
        ...
        if (typ != null) {
            if (!((t instanceof com.pullenti.ner.TextToken))) 
                return null;
            NamedItemToken res = _new1584(typ.getBeginToken(), typ.getEndToken(), typ.getMorph(), typ.chars);
        ...
        if (nam != null) {
            if (nam.getBeginToken().chars.isAllLower()) 
                return null;
            NamedItemToken res = _new1584(nam.getBeginToken(), nam.getEndToken(), nam.getMorph(), nam.chars);
        ...
        if (adj != null) {
            if (adj.getMorph()._getClass().isNoun()) {
                if (adj.getEndToken().isValue("ВОСТОК", null)) {
                    if (adj.getBeginToken() == adj.getEndToken()) 
                        return null;
                    NamedItemToken re = _new1586(t, adj.getEndToken(), adj.getMorph());
            ...
            if ((adj.getEndToken().getNext() instanceof com.pullenti.ner.ReferentToken) && (adj.getEndToken().getNext().getReferent() instanceof com.pullenti.ner.geo.GeoReferent)) {
                NamedItemToken re = _new1586(t, adj.getEndToken().getNext(), adj.getEndToken().getNext().getMorph());
                re.kind = com.pullenti.ner.named.NamedEntityKind.LOCATION;
        ...
        if (((t instanceof com.pullenti.ner.TextToken) && t.chars.isLetter() && !t.chars.isAllLower()) && t.getLengthChar() > 2) {
            NamedItemToken res = _new1586(t, t, t.getMorph());
    ...
    public static NamedItemToken _new1583(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.Referent _arg3, com.pullenti.ner.MorphCollection _arg4) {
        NamedItemToken res = new NamedItemToken(_arg1, _arg2);
        res.ref = _arg3;
        res.setMorph(_arg4);
        return res;
    }
    public static NamedItemToken _new1584(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.MorphCollection _arg3, com.pullenti.morph.CharsInfo _arg4) {
        NamedItemToken res = new NamedItemToken(_arg1, _arg2);
        res.setMorph(_arg3);
        res.chars = _arg4;
        return res;
    }
    public static NamedItemToken _new1586(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.MorphCollection _arg3) {
        NamedItemToken res = new NamedItemToken(_arg1, _arg2);
        res.setMorph(_arg3);
        return res;
    }
