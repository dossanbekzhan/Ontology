...
public class OrgItemEngItem extends com.pullenti.ner.MetaToken {
    ...
    public boolean isBank() {
        return com.pullenti.n2j.Utils.stringsEq(fullValue, "bank");
    }
    ...
    private static boolean _checkTok(com.pullenti.ner.core.TerminToken tok) {
        if (com.pullenti.n2j.Utils.stringsEq(tok.termin.acronym, "SA")) {
            ...
            if (tt0 instanceof com.pullenti.ner.TextToken) {
                if (com.pullenti.n2j.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(tt0, com.pullenti.ner.TextToken.class))).term, "U")) 
                    return false;
            }
        }
    ...
    public static com.pullenti.ner.ReferentToken tryAttachOrg(com.pullenti.ner.Token t, boolean canBeCyr) {
        ...
        if (t instanceof com.pullenti.ner.NumberToken) {
            if ((((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.NumberToken.class))).typ == com.pullenti.ner.NumberSpellingType.WORDS && t.getMorph()._getClass().isAdjective() && t.chars.isCapitalUpper()) {
            }
            else 
                return null;
        }
        ...
        for(; t != null; t = t.getNext()) {
            ...
            if (t.isChar('(') && t.getNext() != null) {
                if ((t.getNext().getReferent() instanceof com.pullenti.ner.geo.GeoReferent) && t.getNext().getNext() != null && t.getNext().getNext().isChar(')')) {
                    _geo = (com.pullenti.ner.geo.GeoReferent)com.pullenti.n2j.Utils.cast(t.getNext().getReferent(), com.pullenti.ner.geo.GeoReferent.class);
                    t = t.getNext().getNext();
                    continue;
                }
        ...
        if (t0 == tok.getBeginToken()) {
            ...
            if (br2 != null) {
                com.pullenti.ner.org.OrganizationReferent org1 = new com.pullenti.ner.org.OrganizationReferent();
        ...
        com.pullenti.ner.org.OrganizationReferent _org = new com.pullenti.ner.org.OrganizationReferent();
        com.pullenti.ner.Token te = tok.getEndToken();
        if (tok.isBank()) 
            t1 = tok.getEndToken();
        if (com.pullenti.n2j.Utils.stringsEq(tok.fullValue, "company") && (tok.getWhitespacesAfterCount() < 3)) {
        ...
        if (com.pullenti.n2j.Utils.stringsEq(tok.fullValue, "company")) {
            if (namWo == 0) 
                return null;
        }
        String nam = com.pullenti.ner.core.MiscHelper.getTextValue(t0, t1, com.pullenti.ner.core.GetTextAttr.IGNOREARTICLES);
        if (com.pullenti.n2j.Utils.stringsEq(nam, "STOCK") && com.pullenti.n2j.Utils.stringsEq(tok.fullValue, "company")) 
            return null;
        String altNam = null;
        ...
        if (tok.isBank()) {
            ...
            _org.addProfile(com.pullenti.ner.org.OrgProfile.FINANCE);
            if ((t1.getNext() != null && t1.getNext().isValue("OF", null) && t1.getNext().getNext() != null) && t1.getNext().getNext().chars.isLatinLetter()) {
                ...
                if (te.getReferent() instanceof com.pullenti.ner.geo.GeoReferent) 
                    _org.addGeoObject((com.pullenti.ner.geo.GeoReferent)com.pullenti.n2j.Utils.cast(te.getReferent(), com.pullenti.ner.geo.GeoReferent.class));
            }
            else if (t0 == t1) 
                return null;
        }
        ...
        com.pullenti.ner.ReferentToken res = new com.pullenti.ner.ReferentToken(_org, t0, te, null);
        t = te;
    ...
    public static void initialize() {
        ...
        t = new com.pullenti.ner.core.Termin("BANK", new com.pullenti.morph.MorphLang(null), false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("Public Limited Company".toUpperCase(), "PLC");
        t.addAbridge("P.L.C.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("Limited Liability Company".toUpperCase(), "LLC");
        t.addAbridge("L.L.C.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("Limited Liability Partnership".toUpperCase(), "LLP");
        t.addAbridge("L.L.P.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("Limited Liability Limited Partnership".toUpperCase(), "LLLP");
        t.addAbridge("L.L.L.P.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("Limited Duration Company".toUpperCase(), "LDC");
        t.addAbridge("L.D.C.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("International Business Company".toUpperCase(), "IBC");
        t.addAbridge("I.B.S.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("Joint stock company".toUpperCase(), "JSC");
        t.addAbridge("J.S.C.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("Open Joint stock company".toUpperCase(), "OJSC");
        t.addAbridge("O.J.S.C.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("Sosiedad Anonima".toUpperCase(), "SA");
        t.addVariant("Sociedad Anonima".toUpperCase(), false);
        t.addAbridge("S.A.");
        t.addVariant("SPA", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("Société en commandite".toUpperCase(), "SC");
        t.addAbridge("S.C.");
        t.addVariant("SCS", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("Societas Europaea".toUpperCase(), "SE");
        t.addAbridge("S.E.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("Società in accomandita".toUpperCase(), "SAS");
        m_Ontology.add(t);
        t.addAbridge("S.C.A.");
        t = com.pullenti.ner.core.Termin._new113("Société en commandite par actions".toUpperCase(), "SCA");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("Société en nom collectif".toUpperCase(), "SNC");
        t.addVariant("Società in nome collettivo".toUpperCase(), false);
        t.addAbridge("S.N.C.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("General Partnership".toUpperCase(), "GP");
        t.addVariant("General Partners", false);
        t.addAbridge("G.P.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("Limited Partnership".toUpperCase(), "LP");
        t.addAbridge("L.P.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("Kommanditaktiengesellschaft".toUpperCase(), "KGAA");
        t.addVariant("KOMMAG", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("Societe a Responsidilite Limitee".toUpperCase(), "SRL");
        t.addAbridge("S.A.R.L.");
        t.addAbridge("S.R.L.");
        t.addVariant("SARL", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("Società a garanzia limitata".toUpperCase(), "SAGL");
        t.addAbridge("S.A.G.L.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("Società limitata".toUpperCase(), "SL");
        t.addAbridge("S.L.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("Vennootschap Met Beperkte Aansparkelij kheid".toUpperCase(), "BV");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("Vennootschap Met Beperkte Aansparkelij".toUpperCase(), "AVV");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("Naamlose Vennootschap".toUpperCase(), "NV");
        t.addAbridge("N.V.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("Gesellschaft mit beschrakter Haftung".toUpperCase(), "GMBH");
        t.addVariant("ГМБХ", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("Aktiengesellschaft".toUpperCase(), "AG");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("International Company".toUpperCase(), "IC");
        t.addAbridge("I.C.");
        m_Ontology.add(t);
        t = new com.pullenti.ner.core.Termin("And Company".toUpperCase(), new com.pullenti.morph.MorphLang(null), false);
        t.addVariant("& Company", false);
        t.addVariant("& Co", false);
        t.addVariant("& Company", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("Kollektivgesellschaft".toUpperCase(), "KG");
        t.addAbridge("K.G.");
        t.addVariant("OHG", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new113("Kommanditgesellschaft".toUpperCase(), "KG");
        ...
        m_Ontology.add(t);
        t = new com.pullenti.ner.core.Termin("PRIVATE LIMITED", new com.pullenti.morph.MorphLang(null), false);
        ...
        m_Ontology.add(t);
        t = new com.pullenti.ner.core.Termin("COMPANY", new com.pullenti.morph.MorphLang(null), false);
        m_Ontology.add(t);
    }
