...
public class OrgItemNameToken extends com.pullenti.ner.MetaToken {
        ...
        if (t.isValue("ОРДЕНА", null) && t.getNext() != null) {
            ...
            if ((t.getWhitespacesAfterCount() < 2) && com.pullenti.ner.core.BracketHelper.canBeStartOfSequence(t.getNext(), true, false)) {
                ...
                if (br != null && (br.getLengthChar() < 40)) 
                    return _new1643(t, br.getEndToken(), true);
            }
        }
        ...
        if (res == null) {
            if (extOnto) {
                if (((t.getReferent() instanceof com.pullenti.ner.geo.GeoReferent)) || (((t instanceof com.pullenti.ner.TextToken) && !t.isChar(';')))) 
                    return _new1647(t, t, t.getSourceText());
            }
            return null;
        }
    ...
    private static java.util.ArrayList<String> m_NotTerminateNouns = new java.util.ArrayList<>(java.util.Arrays.asList(new String[] {"РАБОТА", "ВОПРОС", "ДЕЛО", "УПРАВЛЕНИЕ", "ОРГАНИЗАЦИЯ", "ОБЕСПЕЧЕНИЕ", "РОБОТА", "ПИТАННЯ", "СПРАВА", "УПРАВЛІННЯ", "ОРГАНІЗАЦІЯ", "ЗАБЕЗПЕЧЕННЯ"}));
    ...
    private static OrgItemNameToken _TryAttach(com.pullenti.ner.Token t, OrgItemNameToken prev, boolean extOnto) {
        ...
        if (r != null) {
            if (com.pullenti.n2j.Utils.stringsEq(r.getTypeName(), "DENOMINATION")) 
                return _new1648(t, t, r.toString(true, t.kit.baseLanguage, 0), true);
        ...
        if (tok != null) 
            return _new1649(t, tok.getEndToken(), tok.termin.getCanonicText(), tok.termin.tag == null, tok.termin.tag != null, tok.getMorph());
        if ((((tok = m_StdNames.tryParse(t, com.pullenti.ner.core.TerminParseAttr.NO)))) != null) 
            return _new1650(t, tok.getEndToken(), tok.termin.getCanonicText(), true);
        OrgItemEngItem eng = OrgItemEngItem.tryAttach(t, false);
        if (eng == null && t.isChar(',')) 
            eng = OrgItemEngItem.tryAttach(t.getNext(), false);
        if (eng != null) 
            return _new1651(t, eng.getEndToken(), eng.fullValue, true);
        ...
        if (tt.isChar(',') && prev != null) {
            ...
            if (ty != null) 
                return null;
            res = _new1652(npt1.getBeginToken(), npt1.getEndToken(), npt1.getMorph(), npt1.getNormalCaseText(new com.pullenti.morph.MorphClass(null), false, com.pullenti.morph.MorphGender.UNDEFINED, false));
        ...
        if (((tt.isChar('&') || tt.isValue("AND", null) || tt.isValue("UND", null))) && prev != null) {
            if ((tt.getNext() instanceof com.pullenti.ner.TextToken) && tt.getLengthChar() == 1 && tt.getNext().chars.isLatinLetter()) {
                res = _new1653(tt, tt.getNext(), tt.getNext().chars);
                res.isAfterConjunction = true;
        ...
        if (npt != null && ((explOk || npt.getMorph().getCase().isGenitive() || ((prev != null && !((com.pullenti.morph.MorphCase.ooBitand(prev.getMorph().getCase(), npt.getMorph().getCase()))).isUndefined()))))) {
            ...
            res = _new1652(npt.getBeginToken(), npt.getEndToken(), npt.getMorph(), npt.getNormalCaseText(new com.pullenti.morph.MorphClass(null), false, com.pullenti.morph.MorphGender.UNDEFINED, false));
            res.isNounPhrase = true;
            if ((npt.getEndToken().getWhitespacesAfterCount() < 2) && (npt.getEndToken().getNext() instanceof com.pullenti.ner.TextToken)) {
                ...
                if (npt2 != null && npt2.getMorph().getCase().isGenitive() && npt2.chars.isAllLower()) {
                    ...
                    if (mv2.isAdjective() && mv2.isVerb()) {
                        com.pullenti.morph.MorphBaseInfo bi = com.pullenti.morph.MorphBaseInfo._new1655(npt.getMorph().getCase(), npt.getMorph().getGender(), npt.getMorph().getNumber());
            ...
            if (npt != null) {
                ...
                if (com.pullenti.n2j.Utils.stringsEq(tt.term, "ПО")) 
                    ...
                    ok = npt.getMorph().getCase().isPrepositional();
                if (ok) {
                    res = _new1657(t, npt.getEndToken(), npt.getMorph(), npt.getNormalCaseText(new com.pullenti.morph.MorphClass(null), true, com.pullenti.morph.MorphGender.UNDEFINED, false), npt.chars);
                    res.isNounPhrase = true;
            ...
            if (t1 != null && t1.chars.isLatinLetter() && !t1.chars.isAllLower()) {
                res = _new1658(t, t1, t1.chars, t1.getMorph());
        ...
        if (res == null) {
            ...
            res = _new1659(tt, tt, tt.term, tt.getMorph());
    ...
    public static OrgItemNameToken _new1643(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, boolean _arg3) {
        OrgItemNameToken res = new OrgItemNameToken(_arg1, _arg2);
        res.isIgnoredPart = _arg3;
        return res;
    }
    public static OrgItemNameToken _new1647(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3) {
        OrgItemNameToken res = new OrgItemNameToken(_arg1, _arg2);
        res.value = _arg3;
        return res;
    }
    public static OrgItemNameToken _new1648(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, boolean _arg4) {
        OrgItemNameToken res = new OrgItemNameToken(_arg1, _arg2);
        res.value = _arg3;
        res.isDenomination = _arg4;
        return res;
    }
    public static OrgItemNameToken _new1649(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, boolean _arg4, boolean _arg5, com.pullenti.ner.MorphCollection _arg6) {
        OrgItemNameToken res = new OrgItemNameToken(_arg1, _arg2);
        res.value = _arg3;
        res.isStdTail = _arg4;
    ...
    public static OrgItemNameToken _new1650(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, boolean _arg4) {
        OrgItemNameToken res = new OrgItemNameToken(_arg1, _arg2);
        res.value = _arg3;
        res.isStdName = _arg4;
        return res;
    ...
    public static OrgItemNameToken _new1652(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.MorphCollection _arg3, String _arg4) {
        OrgItemNameToken res = new OrgItemNameToken(_arg1, _arg2);
        res.setMorph(_arg3);
        res.value = _arg4;
        return res;
    }
    public static OrgItemNameToken _new1653(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.morph.CharsInfo _arg3) {
        OrgItemNameToken res = new OrgItemNameToken(_arg1, _arg2);
        res.chars = _arg3;
        return res;
    }
    public static OrgItemNameToken _new1657(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.MorphCollection _arg3, String _arg4, com.pullenti.morph.CharsInfo _arg5) {
        OrgItemNameToken res = new OrgItemNameToken(_arg1, _arg2);
        res.setMorph(_arg3);
        res.value = _arg4;
        res.chars = _arg5;
    ...
    public static OrgItemNameToken _new1658(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.morph.CharsInfo _arg3, com.pullenti.ner.MorphCollection _arg4) {
        OrgItemNameToken res = new OrgItemNameToken(_arg1, _arg2);
        res.chars = _arg3;
        res.setMorph(_arg4);
        return res;
    }
    public static OrgItemNameToken _new1659(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, com.pullenti.ner.MorphCollection _arg4) {
        OrgItemNameToken res = new OrgItemNameToken(_arg1, _arg2);
        res.value = _arg3;
        res.setMorph(_arg4);
        return res;
    }
    public static OrgItemNameToken _new2164(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, boolean _arg3) {
        OrgItemNameToken res = new OrgItemNameToken(_arg1, _arg2);
        res.isStdName = _arg3;
        return res;
    }
    public static OrgItemNameToken _new2166(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, com.pullenti.morph.CharsInfo _arg4) {
        OrgItemNameToken res = new OrgItemNameToken(_arg1, _arg2);
        res.value = _arg3;
        res.chars = _arg4;
        return res;
