...
public class ResourceHelper {
    ...
    public static byte[] getBytes(String name) {
        ...
        String[] names = com.pullenti.ner.org.properties.Resources.getNames();
        for(String n : names) {
            if (n.toUpperCase().endsWith(name.toUpperCase())) {
                try {
                    Object inf = com.pullenti.ner.org.properties.Resources.getResourceInfo(n);
                    if (inf == null) 
                        continue;
                    try (com.pullenti.n2j.Stream stream = com.pullenti.ner.org.properties.Resources.getStream(n)) {
