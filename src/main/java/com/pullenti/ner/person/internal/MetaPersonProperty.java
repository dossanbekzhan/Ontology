...
public class MetaPersonProperty extends com.pullenti.ner.ReferentClass {
    ...
    public MetaPersonProperty() {
        super();
        addFeature(com.pullenti.ner.person.PersonPropertyReferent.ATTR_NAME, "Наименование", 1, 1);
        addFeature(com.pullenti.ner.person.PersonPropertyReferent.ATTR_HIGHER, "Вышестоящее свойство", 0, 0);
        addFeature(com.pullenti.ner.person.PersonPropertyReferent.ATTR_ATTR, "Атрибут", 0, 0);
        addFeature(com.pullenti.ner.person.PersonPropertyReferent.ATTR_REF, "Ссылка на объект", 0, 1);
        addFeature(com.pullenti.ner.Referent.ATTR_GENERAL, "Обобщающее свойство", 1, 0);
    }
    ...
    public String getImageId(com.pullenti.ner.Referent obj) {
        ...
        if (obj instanceof com.pullenti.ner.person.PersonPropertyReferent) 
            ki = (((com.pullenti.ner.person.PersonPropertyReferent)com.pullenti.n2j.Utils.cast(obj, com.pullenti.ner.person.PersonPropertyReferent.class))).getKind();
    ...
    public static MetaPersonProperty globalMeta = new MetaPersonProperty();
}
