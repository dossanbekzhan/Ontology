...
public class PersonAttrToken extends com.pullenti.ner.ReferentToken {
    ...
    public static PersonAttrToken tryAttach(com.pullenti.ner.Token t, com.pullenti.ner.core.IntOntologyCollection locOnto, PersonAttrAttachAttrs attrs) {
        ...
        Object olev = null;
        int lev = 0;
        com.pullenti.n2j.Outargwrapper<Object> inoutarg2189 = new com.pullenti.n2j.Outargwrapper<>();
        Boolean inoutres2190 = com.pullenti.n2j.Utils.tryGetValue(t.kit.miscData, "pat", inoutarg2189);
        olev = inoutarg2189.value;
        if (!inoutres2190) 
        ...
        if (res == null) {
            if (t.getMorph()._getClass().isNoun()) {
                ...
                if (aterr != null) {
                    ...
                    if (rt != null) {
                        res = _new2186(rt.getBeginToken(), rt.getEndToken(), rt.getMorph());
            ...
            if (((((t instanceof com.pullenti.ner.TextToken)) && com.pullenti.n2j.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, "АК") && t.getNext() != null) && t.getNext().isChar('.') && t.getNext().getNext() != null) && !t.getNext().getNext().chars.isAllLower()) {
                res = _new2187(t, t.getNext(), PersonAttrTerminType.POSITION);
                res.setPropRef(com.pullenti.ner.person.PersonPropertyReferent._new2188("академик"));
                return res;
            }
    ...
    private static PersonAttrToken _TryAttach(com.pullenti.ner.Token t, com.pullenti.ner.core.IntOntologyCollection locOnto, PersonAttrAttachAttrs attrs) {
        ...
        if (nta != null) {
            if (nta.getMorph()._getClass().isAdjective() || ((t.getPrevious() != null && t.getPrevious().isComma())) || ((nta.getEndToken().getNext() != null && nta.getEndToken().getNext().isCharOf(",.")))) 
                return _new2191(t, nta.getEndToken(), PersonAttrTerminType.OTHER, ((Long)nta.value).toString(), nta.getMorph());
        }
        if (t.isNewlineBefore()) {
            ...
            if (li != null && li.typ == com.pullenti.ner.mail.internal.MailLine.Types.BESTREGARDS) 
                return _new2193(li.getBeginToken(), li.getEndToken(), PersonAttrTerminType.BESTREGARDS, com.pullenti.ner.MorphCollection._new2192(com.pullenti.morph.MorphCase.NOMINATIVE));
        }
        ...
        if ((com.pullenti.n2j.Utils.stringsEq(tt.term, "Г") || com.pullenti.n2j.Utils.stringsEq(tt.term, "ГР") || com.pullenti.n2j.Utils.stringsEq(tt.term, "М")) || com.pullenti.n2j.Utils.stringsEq(tt.term, "Д")) {
            if (tt.getNext() != null && tt.getNext().isHiphen() && (tt.getNext().getNext() instanceof com.pullenti.ner.TextToken)) {
                ...
                if (vars != null) {
                    PersonAttrToken res = _new2187(tt, tt.getNext().getNext(), PersonAttrTerminType.PREFIX);
        ...
        if (com.pullenti.n2j.Utils.stringsEq(tt.term, "ГР") || com.pullenti.n2j.Utils.stringsEq(tt.term, "ГРАЖД")) {
            ...
            if (t1.getNext() instanceof com.pullenti.ner.NumberToken) 
                return null;
            return _new2195(tt, t1, PersonAttrTerminType.PREFIX, (tt.getMorph().getLanguage().isUa() ? "ГРОМАДЯНИН" : "ГРАЖДАНИН"));
        }
        ...
        for(int step = 0; step < 2; step++) {
            ...
            if (toks == null && t.isValue("ВРИО", null)) {
                ...
                if (str.endsWith("MAN") || str.endsWith("PERSON") || str.endsWith("MIST")) {
                    toks = new java.util.ArrayList<>();
                    toks.add(com.pullenti.ner.core.TerminToken._new597(t, t, PersonAttrTermin._new2197(str, t.getMorph().getLanguage(), PersonAttrTerminType.POSITION)));
                }
                ...
                for(com.pullenti.ner.core.TerminToken tok : toks) {
                    ...
                    if (pat.typ == PersonAttrTerminType.PREFIX) {
                        if (step == 0 || ((com.pullenti.n2j.Utils.stringsNe(pat.getCanonicText(), "ГРАЖДАНИН") && com.pullenti.n2j.Utils.stringsNe(pat.getCanonicText(), "ГРОМАДЯНИН")))) 
                            return _new2201(tok.getBeginToken(), tok.getEndToken(), PersonAttrTerminType.PREFIX, pat.getCanonicText(), tok.getMorph(), pat.getGender());
                    }
                    if (pat.typ == PersonAttrTerminType.BESTREGARDS) {
                        ...
                        return _new2193(tok.getBeginToken(), end, PersonAttrTerminType.BESTREGARDS, com.pullenti.ner.MorphCollection._new2192(com.pullenti.morph.MorphCase.NOMINATIVE));
                    }
                    if (pat.typ == PersonAttrTerminType.POSITION || pat.typ == PersonAttrTerminType.PREFIX || pat.typ == PersonAttrTerminType.KING) {
                        ...
                        if (res != null) {
                            ...
                            if (npt0 != null) {
                                ...
                                if (emptyAdj != null) {
                                    PersonAttrToken res1 = _new2204(res.getBeginToken(), res.getEndToken(), npt0.getMorph(), res);
            ...
            if ((te != null && te.getPrevious().isHiphen() && !te.isWhitespaceAfter()) && !te.isWhitespaceBefore()) {
                if (com.pullenti.ner.core.BracketHelper.isBracket(te, false)) {
                    ...
                    if (br != null && (te instanceof com.pullenti.ner.TextToken)) {
                        ppp = _new2186(t, br.getEndToken(), br.getEndToken().getPrevious().getMorph());
    ...
    private static java.util.ArrayList<com.pullenti.morph.MorphWordForm> getStdForms(String tail, String w1, String w2) {
        ...
        Boolean inoutres2209 = com.pullenti.n2j.Utils.tryGetValue(m_StdForms, w1, inoutarg2208);
        li1 = inoutarg2208.value;
        if (!inoutres2209) {
        ...
        if (w2 != null) {
            com.pullenti.n2j.Outargwrapper<java.util.ArrayList<com.pullenti.morph.MorphWordForm>> inoutarg2206 = new com.pullenti.n2j.Outargwrapper<>();
            Boolean inoutres2207 = com.pullenti.n2j.Utils.tryGetValue(m_StdForms, w2, inoutarg2206);
            li2 = inoutarg2206.value;
            if (!inoutres2207) {
    ...
    private static PersonAttrToken createAttrPosition(com.pullenti.ner.core.TerminToken tok, com.pullenti.ner.core.IntOntologyCollection locOnto, PersonAttrAttachAttrs attrs) {
        ...
        if (ty2 == PersonAttrTerminType2.ABBR) {
            ...
            return _new2210(tok.getBeginToken(), tok.getEndToken(), pr0, PersonAttrTerminType.POSITION);
        }
        if (ty2 == PersonAttrTerminType2.IO || ty2 == PersonAttrTerminType2.IO2) {
            for(int k = 0; ; k++) {
                ...
                if (tt != null && tt.getMorph()._getClass().isPreposition()) 
                    tt = tt.getNext();
                PersonAttrToken resPat = _new2187(tok.getBeginToken(), tok.getEndToken(), PersonAttrTerminType.POSITION);
                ...
                com.pullenti.n2j.Outargwrapper<String> inoutarg2212 = new com.pullenti.n2j.Outargwrapper<>(nam);
                resPat.setBeginToken(_analizeVise(resPat.getBeginToken(), inoutarg2212));
                nam = inoutarg2212.value;
        ...
        if (ty2 == PersonAttrTerminType2.GRADE) {
            ...
            if (tok.getBeginToken().isValue("КАНДИДАТ", null)) {
                ...
                if (tt != null) {
                    ...
                    if (pat2 != null) {
                        PersonAttrToken res0 = _new2187(tok.getBeginToken(), pat2.getEndToken(), PersonAttrTerminType.POSITION);
                        res0.setPropRef(com.pullenti.ner.person.PersonPropertyReferent._new2188("кандидат"));
        ...
        com.pullenti.n2j.Outargwrapper<String> inoutarg2224 = new com.pullenti.n2j.Outargwrapper<>(name);
        t0 = _analizeVise(t0, inoutarg2224);
        name = inoutarg2224.value;
        ...
        for(com.pullenti.ner.Token t = t1.getNext(); t != null; t = t.getNext()) {
                        ...
                        if (zap && !and) {
                            ...
                            if (_isPerson(tt1.getNext())) 
                                ...
                                if (_isPerson(tt1.getNext().getNext())) 
                                    ...
                                    String ccc;
                                    com.pullenti.n2j.Outargwrapper<String> inoutarg2215 = new com.pullenti.n2j.Outargwrapper<>();
                                    com.pullenti.ner.Token ttt = tryAttachCategory(tt1.getNext().getNext(), inoutarg2215);
                                    ccc = inoutarg2215.value;
                                    if (ttt != null) 
                                        ok = true;
                                }
                            }
            ...
            if ((te.chars.isLatinLetter() && te.getLengthChar() > 1 && !t0.chars.isLatinLetter()) && !te.chars.isAllLower()) {
                if (r == null || com.pullenti.n2j.Utils.stringsNe(r.getTypeName(), objNameOrg)) {
                    com.pullenti.n2j.Outargwrapper<String> inoutarg2216 = new com.pullenti.n2j.Outargwrapper<>();
                    com.pullenti.ner.Token tt = tryAttachCategory(t, inoutarg2216);
                    category = inoutarg2216.value;
            ...
            if (category == null) {
                ...
                com.pullenti.ner.Token tt = tryAttachCategory(t, inoutarg2217);
                category = inoutarg2217.value;
                if (tt != null && name != null) {
                    t = (t1 = tt);
                    continue;
                }
            ...
            if (!t.chars.isAllLower()) {
                if (t.kit.miscData.containsKey("TestAttr")) {
                    ...
                    if (pits != null && pits.size() > 1) {
                        ...
                        java.util.ArrayList<PersonIdentityToken> li = PersonIdentityToken.tryAttach(pits, 0, com.pullenti.morph.MorphBaseInfo._new2218(com.pullenti.morph.MorphCase.ALLCASES), null, false, false);
                        t.kit.miscData.remove("TestAttr");
                        if (li.size() > 0 && li.get(0).coef > 1) {
                            t.kit.miscData.put("TestAttr", null);
                            java.util.ArrayList<PersonIdentityToken> li1 = PersonIdentityToken.tryAttach(pits, iii, com.pullenti.morph.MorphBaseInfo._new2218(com.pullenti.morph.MorphCase.ALLCASES), null, false, false);
                            t.kit.miscData.remove("TestAttr");
                            if (li1.size() == 0) 
                                break;
                            ...
                            t.kit.miscData.put("TestAttr", null);
                            java.util.ArrayList<PersonIdentityToken> li1 = PersonIdentityToken.tryAttach(pits, 1, com.pullenti.morph.MorphBaseInfo._new2218(com.pullenti.morph.MorphCase.ALLCASES), null, false, false);
                            t.kit.miscData.remove("TestAttr");
        ...
        if (category != null) 
            ...
            com.pullenti.n2j.Outargwrapper<String> inoutarg2221 = new com.pullenti.n2j.Outargwrapper<>();
            com.pullenti.ner.Token tt = tryAttachCategory(t1.getNext(), inoutarg2221);
            category = inoutarg2221.value;
            if (tt != null) {
                name = name + " " + category;
                t1 = tt;
            }
        ...
        pr.setName(name);
        PersonAttrToken res = _new2222(t0, t1, PersonAttrTerminType.POSITION, pr, tok.getMorph());
        ...
        if (i >= 0) {
            i += 11;
            PersonAttrToken res1 = _new2193(t0, t1, PersonAttrTerminType.POSITION, tok.getMorph());
            res1.setPropRef(new com.pullenti.ner.person.PersonPropertyReferent());
    ...
    private static PersonAttrToken createAttrGrade(com.pullenti.ner.core.TerminToken tok) {
        ...
        return _new2225(tok.getBeginToken(), t1, PersonAttrTerminType.POSITION, pr, tok.getMorph(), false);
    }
    ...
    public static void initialize() throws Exception, java.io.IOException, javax.xml.stream.XMLStreamException, org.xml.sax.SAXException {
        ...
        m_Termins.add(PersonAttrTermin._new2226("ТОВАРИЩ", PersonAttrTerminType.PREFIX));
        m_Termins.add(PersonAttrTermin._new2197("ТОВАРИШ", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.PREFIX));
        for(String s : new String[] {"ГОСПОДИН", "ГРАЖДАНИН", "УРОЖЕНЕЦ", "МИСТЕР", "СЭР", "СЕНЬОР", "МОНСЕНЬОР", "СИНЬОР", "МЕСЬЕ", "МСЬЕ", "ДОН", "МАЭСТРО", "МЭТР"}) {
            t = PersonAttrTermin._new2228(s, PersonAttrTerminType.PREFIX, com.pullenti.morph.MorphGender.MASCULINE);
        ...
        for(String s : new String[] {"ПАН", "ГРОМАДЯНИН", "УРОДЖЕНЕЦЬ", "МІСТЕР", "СЕР", "СЕНЬЙОР", "МОНСЕНЬЙОР", "МЕСЬЄ", "МЕТР", "МАЕСТРО"}) {
            t = PersonAttrTermin._new2229(s, com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.PREFIX, com.pullenti.morph.MorphGender.MASCULINE);
        ...
        for(String s : new String[] {"ГОСПОЖА", "ПАНИ", "ГРАЖДАНКА", "УРОЖЕНКА", "СЕНЬОРА", "СЕНЬОРИТА", "СИНЬОРА", "СИНЬОРИТА", "МИСС", "МИССИС", "МАДАМ", "МАДЕМУАЗЕЛЬ", "ФРАУ", "ФРОЙЛЯЙН", "ЛЕДИ", "ДОННА"}) {
            t = PersonAttrTermin._new2228(s, PersonAttrTerminType.PREFIX, com.pullenti.morph.MorphGender.FEMINIE);
        ...
        for(String s : new String[] {"ПАНІ", "ГРОМАДЯНКА", "УРОДЖЕНКА", "СЕНЬЙОРА", "СЕНЬЙОРА", "МІС", "МІСІС", "МАДАМ", "МАДЕМУАЗЕЛЬ", "ФРАУ", "ФРОЙЛЯЙН", "ЛЕДІ"}) {
            t = PersonAttrTermin._new2229(s, com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.PREFIX, com.pullenti.morph.MorphGender.FEMINIE);
        ...
        t = PersonAttrTermin._new2229("MISTER", com.pullenti.morph.MorphLang.EN, PersonAttrTerminType.PREFIX, com.pullenti.morph.MorphGender.MASCULINE);
        t.addAbridge("MR");
        t.addAbridge("MR.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2229("MISSIS", com.pullenti.morph.MorphLang.EN, PersonAttrTerminType.PREFIX, com.pullenti.morph.MorphGender.FEMINIE);
        t.addAbridge("MRS");
        t.addAbridge("MSR.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2229("MISS", com.pullenti.morph.MorphLang.EN, PersonAttrTerminType.PREFIX, com.pullenti.morph.MorphGender.FEMINIE);
        t.addAbridge("MS");
        t.addAbridge("MS.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2226("БЕЗРАБОТНЫЙ", PersonAttrTerminType.POSITION);
        ...
        m_Termins.add(t);
        t = PersonAttrTermin._new2197("БЕЗРОБІТНИЙ", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.POSITION);
        ...
        m_Termins.add(t);
        t = PersonAttrTermin._new2237("ЗАМЕСТИТЕЛЬ", "заместитель", PersonAttrTerminType2.IO2, PersonAttrTerminType.POSITION);
        t.addVariant("ЗАМЕСТИТЕЛЬНИЦА", false);
        t.addAbridge("ЗАМ.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2238("ЗАСТУПНИК", com.pullenti.morph.MorphLang.UA, "заступник", PersonAttrTerminType2.IO2, PersonAttrTerminType.POSITION);
        t.addVariant("ЗАСТУПНИЦЯ", false);
        t.addAbridge("ЗАМ.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2237("УПОЛНОМОЧЕННЫЙ", "уполномоченный", PersonAttrTerminType2.IO2, PersonAttrTerminType.POSITION);
        m_Termins.add(t);
        t = PersonAttrTermin._new2238("УПОВНОВАЖЕНИЙ", com.pullenti.morph.MorphLang.UA, "уповноважений", PersonAttrTerminType2.IO2, PersonAttrTerminType.POSITION);
        m_Termins.add(t);
        t = PersonAttrTermin._new2237("ЭКС-УПОЛНОМОЧЕННЫЙ", "экс-уполномоченный", PersonAttrTerminType2.IO2, PersonAttrTerminType.POSITION);
        m_Termins.add(t);
        t = PersonAttrTermin._new2238("ЕКС-УПОВНОВАЖЕНИЙ", com.pullenti.morph.MorphLang.UA, "екс-уповноважений", PersonAttrTerminType2.IO2, PersonAttrTerminType.POSITION);
        m_Termins.add(t);
        t = PersonAttrTermin._new2243("ИСПОЛНЯЮЩИЙ ОБЯЗАННОСТИ", PersonAttrTerminType2.IO, PersonAttrTerminType.POSITION);
        t.addAbridge("И.О.");
        t.setCanonicText((t.acronym = "ИО"));
        m_Termins.add(t);
        t = PersonAttrTermin._new2244("ВИКОНУЮЧИЙ ОБОВЯЗКИ", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType2.IO, PersonAttrTerminType.POSITION);
        t.addAbridge("В.О.");
        t.setCanonicText((t.acronym = "ВО"));
        m_Termins.add(t);
        t = PersonAttrTermin._new2243("ВРЕМЕННО ИСПОЛНЯЮЩИЙ ОБЯЗАННОСТИ", PersonAttrTerminType2.IO, PersonAttrTerminType.POSITION);
        t.addAbridge("ВР.И.О.");
        t.setCanonicText((t.acronym = "ВРИО"));
        m_TerminVrio = t;
        m_Termins.add(t);
        t = PersonAttrTermin._new2226("ЗАВЕДУЮЩИЙ", PersonAttrTerminType.POSITION);
        t.addAbridge("ЗАВЕД.");
        t.addAbridge("ЗАВ.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2197("ЗАВІДУВАЧ", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.POSITION);
        t.addAbridge("ЗАВІД.");
        t.addAbridge("ЗАВ.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2226("СОТРУДНИК", PersonAttrTerminType.POSITION);
        t.addAbridge("СОТРУДН.");
        t.addAbridge("СОТР.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2197("СПІВРОБІТНИК", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.POSITION);
        t.addAbridge("СПІВРОБ.");
        t.addAbridge("СПІВ.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2226("АКАДЕМИК", PersonAttrTerminType.POSITION);
        t.addAbridge("АКАД.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2197("АКАДЕМІК", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.POSITION);
        t.addAbridge("АКАД.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2226("ЧЛЕН-КОРРЕСПОНДЕНТ", PersonAttrTerminType.POSITION);
        t.addAbridge("ЧЛ.-КОРР.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2197("ЧЛЕН-КОРЕСПОНДЕНТ", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.POSITION);
        t.addAbridge("ЧЛ.-КОР.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2226("ДОЦЕНТ", PersonAttrTerminType.POSITION);
        t.addAbridge("ДОЦ.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2226("ПРОФЕССОР", PersonAttrTerminType.POSITION);
        t.addAbridge("ПРОФ.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2197("ПРОФЕСОР", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.POSITION);
        t.addAbridge("ПРОФ.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2197("PROFESSOR", com.pullenti.morph.MorphLang.EN, PersonAttrTerminType.POSITION);
        t.addAbridge("PROF.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2243("КАНДИДАТ", PersonAttrTerminType2.GRADE, PersonAttrTerminType.POSITION);
        t.addAbridge("КАНД.");
        t.addAbridge("КАН.");
        t.addAbridge("К-Т");
        t.addAbridge("К.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2243("ДОКТОР", PersonAttrTerminType2.GRADE, PersonAttrTerminType.POSITION);
        t.addAbridge("ДОКТ.");
        t.addAbridge("ДОК.");
        t.addAbridge("Д-Р");
        t.addAbridge("Д.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2197("DOCTOR", com.pullenti.morph.MorphLang.EN, PersonAttrTerminType.PREFIX);
        t.addAbridge("DR");
        t.addAbridge("DR.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2226("ДОКТОРАНТ", PersonAttrTerminType.POSITION);
        m_Termins.add(t);
        t = PersonAttrTermin._new2197("ДОКТОРАНТ", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.POSITION);
        m_Termins.add(t);
        for(String s : new String[] {"КФН", "КТН", "КХН"}) {
            t = PersonAttrTermin._new2263(s, "кандидат наук", PersonAttrTerminType.POSITION, PersonAttrTerminType2.ABBR);
            m_Termins.add(t);
        }
        for(String s : new String[] {"ГЛАВНЫЙ", "МЛАДШИЙ", "СТАРШИЙ", "ВЕДУЩИЙ", "НАУЧНЫЙ"}) {
            t = PersonAttrTermin._new2243(s, PersonAttrTerminType2.ADJ, PersonAttrTerminType.POSITION);
            t.addAllAbridges(0, 0, 2);
            m_Termins.add(t);
        }
        for(String s : new String[] {"ГОЛОВНИЙ", "МОЛОДШИЙ", "СТАРШИЙ", "ПРОВІДНИЙ", "НАУКОВИЙ"}) {
            t = PersonAttrTermin._new2265(s, PersonAttrTerminType2.ADJ, PersonAttrTerminType.POSITION, com.pullenti.morph.MorphLang.UA);
            t.addAllAbridges(0, 0, 2);
            m_Termins.add(t);
        }
        for(String s : new String[] {"НЫНЕШНИЙ", "НОВЫЙ", "CURRENT", "NEW"}) {
            t = PersonAttrTermin._new2243(s, PersonAttrTerminType2.IGNOREDADJ, PersonAttrTerminType.POSITION);
            m_Termins.add(t);
        }
        for(String s : new String[] {"НИНІШНІЙ", "НОВИЙ"}) {
            t = PersonAttrTermin._new2265(s, PersonAttrTerminType2.IGNOREDADJ, PersonAttrTerminType.POSITION, com.pullenti.morph.MorphLang.UA);
            m_Termins.add(t);
        }
        for(String s : new String[] {"ТОГДАШНИЙ", "БЫВШИЙ", "ПРЕДЫДУЩИЙ", "FORMER", "PREVIOUS", "THEN"}) {
            t = PersonAttrTermin._new2243(s, PersonAttrTerminType2.IO, PersonAttrTerminType.POSITION);
            m_Termins.add(t);
        }
        for(String s : new String[] {"ТОДІШНІЙ", "КОЛИШНІЙ"}) {
            t = PersonAttrTermin._new2265(s, PersonAttrTerminType2.IO, PersonAttrTerminType.POSITION, com.pullenti.morph.MorphLang.UA);
            m_Termins.add(t);
        }
    ...
    private static void loadAttrs(com.pullenti.ner.core.TerminCollection termins, byte[] dat, com.pullenti.morph.MorphLang lang) throws java.io.IOException, javax.xml.stream.XMLStreamException, org.xml.sax.SAXException {
        ...
        try (com.pullenti.n2j.MemoryStream tmp = new com.pullenti.n2j.MemoryStream(deflate(dat))) {
            ...
            for(org.w3c.dom.Node x : (new com.pullenti.n2j.XmlNodeListWrapper(xml.doc.getDocumentElement().getChildNodes())).arr) {
                ...
                PersonAttrTermin pat = PersonAttrTermin._new2270(val, PersonAttrTerminType.POSITION, lang);
    ...
    public static PersonAttrToken _new2186(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.MorphCollection _arg3) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.setMorph(_arg3);
        return res;
    }
    public static PersonAttrToken _new2187(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, PersonAttrTerminType _arg3) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.typ = _arg3;
        return res;
    }
    public static PersonAttrToken _new2191(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, PersonAttrTerminType _arg3, String _arg4, com.pullenti.ner.MorphCollection _arg5) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.age = _arg4;
        res.setMorph(_arg5);
    ...
    public static PersonAttrToken _new2193(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, PersonAttrTerminType _arg3, com.pullenti.ner.MorphCollection _arg4) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.setMorph(_arg4);
        return res;
    }
    public static PersonAttrToken _new2195(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, PersonAttrTerminType _arg3, String _arg4) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        return res;
    }
    public static PersonAttrToken _new2201(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, PersonAttrTerminType _arg3, String _arg4, com.pullenti.ner.MorphCollection _arg5, com.pullenti.morph.MorphGender _arg6) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        res.setMorph(_arg5);
    ...
    public static PersonAttrToken _new2204(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.MorphCollection _arg3, PersonAttrToken _arg4) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.setMorph(_arg3);
        res.higherPropRef = _arg4;
        return res;
    }
    public static PersonAttrToken _new2210(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.person.PersonPropertyReferent _arg3, PersonAttrTerminType _arg4) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.setPropRef(_arg3);
        res.typ = _arg4;
        return res;
    }
    public static PersonAttrToken _new2222(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, PersonAttrTerminType _arg3, com.pullenti.ner.person.PersonPropertyReferent _arg4, com.pullenti.ner.MorphCollection _arg5) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.typ = _arg3;
    ...
    public static PersonAttrToken _new2225(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, PersonAttrTerminType _arg3, com.pullenti.ner.person.PersonPropertyReferent _arg4, com.pullenti.ner.MorphCollection _arg5, boolean _arg6) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.setPropRef(_arg4);
        res.setMorph(_arg5);
