...
public class PersonIdToken extends com.pullenti.ner.MetaToken {
    ...
    private static PersonIdToken tryParse(com.pullenti.ner.Token t, PersonIdToken prev) {
        if (t.isValue("СВИДЕТЕЛЬСТВО", null)) {
            ...
            if (reg && ip) 
                return _new2292(t, tt1, Typs.KEYWORD, "СВИДЕТЕЛЬСТВО О ГОСУДАРСТВЕННОЙ РЕГИСТРАЦИИ ФИЗИЧЕСКОГО ЛИЦА В КАЧЕСТВЕ ИНДИВИДУАЛЬНОГО ПРЕДПРИНИМАТЕЛЯ");
        }
        ...
        if (tok != null) {
            ...
            PersonIdToken res = _new2292(tok.getBeginToken(), tok.getEndToken(), ty, tok.termin.getCanonicText());
            if (prev == null) {
                if (ty != Typs.KEYWORD) 
                    return null;
        ...
        if (t instanceof com.pullenti.ner.NumberToken) {
            StringBuilder tmp = new StringBuilder();
            PersonIdToken res = _new2294(t0, t, Typs.NUMBER);
        ...
        if ((prev != null && prev.typ == Typs.KEYWORD && (t instanceof com.pullenti.ner.TextToken)) && !t.chars.isAllLower() && t.chars.isLetter()) {
            ...
            if (rr != null && rr.typ == Typs.NUMBER) 
                return _new2292(t, t, Typs.SERIA, (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).term);
        }
        if ((t != null && t.isValue("ОТ", "ВІД") && (t.getNext() instanceof com.pullenti.ner.ReferentToken)) && com.pullenti.n2j.Utils.stringsEq(t.getNext().getReferent().getTypeName(), "DATE")) 
            return _new2295(t, t.getNext(), Typs.DATE, t.getNext().getReferent());
        return null;
    }
    ...
    public static PersonIdToken _new2292(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, Typs _arg3, String _arg4) {
        PersonIdToken res = new PersonIdToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        return res;
    }
    public static PersonIdToken _new2294(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, Typs _arg3) {
        PersonIdToken res = new PersonIdToken(_arg1, _arg2);
        res.typ = _arg3;
        return res;
    }
    public static PersonIdToken _new2295(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, Typs _arg3, com.pullenti.ner.Referent _arg4) {
        PersonIdToken res = new PersonIdToken(_arg1, _arg2);
        res.typ = _arg3;
        res.referent = _arg4;
        return res;
