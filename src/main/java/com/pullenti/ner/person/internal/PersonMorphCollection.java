...
public class PersonMorphCollection {
    ...
    public static class PersonMorphVariant {
        ...
        public static PersonMorphVariant _new2376(String _arg1, com.pullenti.morph.MorphGender _arg2, String _arg3) {
    ...
    public void add(String val, String shortval, com.pullenti.morph.MorphGender gen, boolean addOtherGenderVar) {
        ...
        if (gen == com.pullenti.morph.MorphGender.MASCULINE || gen == com.pullenti.morph.MorphGender.FEMINIE) {
            ...
            items.add(PersonMorphVariant._new2376(val, gen, shortval));
            if (addOtherGenderVar) {
                ...
                String v = com.pullenti.morph.Morphology.getWordform(val, com.pullenti.morph.MorphBaseInfo._new211(com.pullenti.morph.MorphClass._new1508(true), g0));
                if (v != null) 
                    items.add(PersonMorphVariant._new2376(v, g0, shortval));
            }
        }
        else {
