...
public class TitlePageAnalyzer extends com.pullenti.ner.Analyzer {
    ...
    public com.pullenti.ner.ReferentToken processReferent1(com.pullenti.ner.Token begin, com.pullenti.ner.Token end) {
        ...
        com.pullenti.n2j.Outargwrapper<com.pullenti.ner.Token> inoutarg2607 = new com.pullenti.n2j.Outargwrapper<>();
        TitlePageReferent tpr = _process(begin, (end == null ? 0 : end.endChar), begin.kit, inoutarg2607);
        et = inoutarg2607.value;
        if (tpr == null) 
            return null;
    ...
    public void process(com.pullenti.ner.core.AnalysisKit kit) {
        ...
        com.pullenti.ner.Token et;
        com.pullenti.n2j.Outargwrapper<com.pullenti.ner.Token> inoutarg2608 = new com.pullenti.n2j.Outargwrapper<>();
        TitlePageReferent tpr = _process(kit.firstToken, 0, kit, inoutarg2608);
        et = inoutarg2608.value;
        if (tpr != null) 
            ...
            for(com.pullenti.ner.Referent r : rli) {
                ...
                if (r instanceof com.pullenti.ner.org.OrganizationReferent) {
                    ...
                    if (_org.getTypes().contains("курс") && _org.getNumber() != null) {
                        int i;
                        com.pullenti.n2j.Outargwrapper<Integer> inoutarg2609 = new com.pullenti.n2j.Outargwrapper<>();
                        boolean inoutres2610 = com.pullenti.n2j.Utils.parseInteger(_org.getNumber(), inoutarg2609);
                        i = (inoutarg2609.value != null ? inoutarg2609.value : 0);
                        if (inoutres2610 && i > 0 && (i < 8)) 
