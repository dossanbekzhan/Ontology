...
public class TitleItemToken extends com.pullenti.ner.MetaToken {
            ...
            if (com.pullenti.n2j.Utils.stringsEq(tt.term, "ТЕМА")) {
                ...
                if (tit != null && tit.typ == Types.TYP) {
                    ...
                    if (t1.getNext() != null && t1.getNext().isChar(':')) 
                        t1 = t1.getNext();
                    return _new2591(t, t1, Types.TYPANDTHEME, tit.value);
                }
            ...
            if (tok != null) {
                ...
                if (ty == Types.TYP) {
                    ...
                    if (tit != null && tit.typ == Types.THEME) 
                        return _new2591(npt.getBeginToken(), tit.getEndToken(), Types.TYPANDTHEME, s);
                    ...
                    return _new2591(npt.getBeginToken(), t1, ty, s);
                }
            }
        }
    ...
    private static TitleItemToken tryAttachSpeciality(com.pullenti.ner.Token t, boolean keyWordBefore) {
        ...
        return _new2591(t0, t, Types.SPECIALITY, val.toString());
    }
    ...
    public static TitleItemToken _new2591(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, Types _arg3, String _arg4) {
