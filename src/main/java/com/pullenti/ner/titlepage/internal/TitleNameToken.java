    ...
    public static boolean canBeStartOfTextOrContent(com.pullenti.ner.Token begin, com.pullenti.ner.Token end) {
        ...
        for(t = begin; t != end.getNext(); t = t.getNext()) {
            if (t instanceof com.pullenti.ner.TextToken) {
                if (t.chars.isLetter()) 
                    words++;
                if (t.chars.isAllLower() && (((com.pullenti.ner.TextToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.TextToken.class))).isPureVerb()) 
                    verbs++;
            }
        }
        if (words > 10 && verbs > 1) 
    ...
    private boolean calcRankAndValue(int minNewlinesCount) {
        ...
        for(com.pullenti.ner.Token t = getBeginToken(); t != getEndToken().getNext() && t != null && t.endChar <= getEndToken().endChar; t = t.getNext()) {
            ...
            if (t instanceof com.pullenti.ner.NumberToken) {
                if ((((com.pullenti.ner.NumberToken)com.pullenti.n2j.Utils.cast(t, com.pullenti.ner.NumberToken.class))).typ == com.pullenti.ner.NumberSpellingType.WORDS) {
                    words++;
                    if (t.chars.isAllUpper()) 
                        upWords++;
                }
            ...
            com.pullenti.ner.org.internal.OrgItemTypeToken oitt = com.pullenti.ner.org.internal.OrgItemTypeToken.tryAttach(t, true, null);
            if (oitt != null) {
        ...
        if (tstart.endChar > tend.endChar) 
            return false;
        TitleItemToken tit1 = TitleItemToken.tryAttach(getEndToken().getNext());
