                        ...
                        if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), TransportReferent.ATTR_MODEL)) {
                            ...
                            for(int k = 0; k < 2; k++) {
                                if (!Character.isDigit(mod.charAt(0))) {
                                    ...
                                    com.pullenti.n2j.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>> inoutarg2636 = new com.pullenti.n2j.Outargwrapper<>();
                                    Boolean inoutres2637 = com.pullenti.n2j.Utils.tryGetValue(objsByModel, mod, inoutarg2636);
                                    li = inoutarg2636.value;
                                    if (!inoutres2637) 
