                        ...
                        if (com.pullenti.n2j.Utils.stringsEq(s.getTypeName(), WeaponReferent.ATTR_MODEL)) {
                            ...
                            for(int k = 0; k < 2; k++) {
                                if (!Character.isDigit(mod.charAt(0))) {
                                    ...
                                    com.pullenti.n2j.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>> inoutarg2723 = new com.pullenti.n2j.Outargwrapper<>();
                                    Boolean inoutres2724 = com.pullenti.n2j.Utils.tryGetValue(objsByModel, mod, inoutarg2723);
                                    li = inoutarg2723.value;
                                    if (!inoutres2724) 
