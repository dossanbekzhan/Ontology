...
public class WeaponReferent extends com.pullenti.ner.Referent {
    ...
    public boolean canBeEquals(com.pullenti.ner.Referent obj, com.pullenti.ner.Referent.EqualType typ) {
        WeaponReferent tr = (WeaponReferent)com.pullenti.n2j.Utils.cast(obj, WeaponReferent.class);
        if (tr == null) 
            return false;
        ...
        for(String t : getStringValues(ATTR_TYPE)) {
        ...
        if (s1 != null || s2 != null) {
            if (s1 == null || s2 == null) {
                ...
                if (findSlot(ATTR_MODEL, s2, true) != null) 
                    return true;
